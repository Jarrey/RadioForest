...
<body>
    ...
    <script>const regionCodes={"中国":"cn","日本":"jp","韩国":"kr","台湾":"tw","香港":"hk","新加坡":"sg","英国":"gb","德国":"de","法国":"fr","意大利":"it","西班牙":"es","俄罗斯":"ru","美国":"us","加拿大":"ca","澳大利亚":"au","澳洲":"au","新西兰":"nz","巴西":"br","墨西哥":"mx","阿根廷":"ar","瑞士":"ch","南非":"za","印度":"in","泰国":"th","越南":"vn","马来西亚":"my","印尼":"id","菲律宾":"ph","土耳其":"tr","荷兰":"nl","比利时":"be","奥地利":"at","波兰":"pl","瑞典":"se","挪威":"no","丹麦":"dk","芬兰":"fi","爱尔兰":"ie","葡萄牙":"pt","希腊":"gr","捷克":"cz","匈牙利":"hu","罗马尼亚":"ro","埃及":"eg","以色列":"il","阿联酋":"ae","沙特":"sa","其他":"un"};function makeSvgLogo(n,a){return`<svg viewBox="0 0 60 52" width="${n}" height="${a}" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="10" width="44" height="32" rx="12" fill="var(--bg-card)" opacity="0.95" stroke="var(--primary)" stroke-width="1"/><rect x="12" y="14" width="22" height="20" rx="6" fill="var(--bg)"/><rect x="14" y="16" width="18" height="16" rx="5" fill="var(--primary-dim)" opacity="0.85"/><circle cx="25" cy="24" r="9" fill="var(--bg)"/><circle cx="25" cy="24" r="6" fill="var(--primary-dim)"/><circle cx="25" cy="24" r="3" fill="var(--bg)"/><path d="M16 24h18" stroke="var(--bg)" stroke-width="2" stroke-linecap="round"/><rect x="36" y="18" width="10" height="14" rx="3" fill="var(--primary-dim)"/><circle cx="41" cy="25" r="2" fill="var(--bg)"/><line x1="38" y1="21" x2="44" y2="21" stroke="var(--bg)" stroke-width="1.5" stroke-linecap="round"/><line x1="38" y1="29" x2="44" y2="29" stroke="var(--bg)" stroke-width="1.5" stroke-linecap="round"/></svg>`}const SVG_LOGO_SM=makeSvgLogo(36,28),SVG_LOGO_MD=makeSvgLogo(44,38),SVG_LOGO_LG=makeSvgLogo(100,87),FAV_HEART_SVG='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>';var allStations=[];const typePatterns={"音乐":/音乐|Music|pop|rock|hit|jazz|classical/i,"新闻":/新闻|News|资讯|information/i,"财经":/财经|金融|股票|经济|Finance|Financial|Business|Economy|Stock|Market|Investment|Banking/i,"综合":/广播|Radio|综合|general/i,"交通":/交通|Traffic|汽车|Auto/i,"体育":/体育|Sports/i,"文艺":/文艺|Culture/i,"经典":/经典|Classic|怀旧|Old/i,"儿童":/儿童|少儿|Kids|children/i,"宗教":/宗教|上帝|Islam|Christian|Quran|佛教/i,"古典":/古典|Symphony|交响/i,"方言":/方言|闽南|粤语|Cantonese|吴语|沪语/i,"爵士":/jazz|爵士/i,"流行":/\bpop\b|流行|top\s*40|\bhits\b|k.?pop|j.?pop/i,"摇滚":/\brock\b|摇滚|\bindie\b|alternative|punk|grunge/i,"嘻哈":/hip.?hop|\brap\b|嘻哈|说唱/i,"电子":/\bedm\b|\belectronic\b|\belectro\b|techno|trance|dance\s*(?:music|fm|radio|hits)|舞曲|电子音乐/i,"R&B":/\br\s*&\s*b\b|rhythm.?blues|soul\s*(?:music|fm|radio)|灵魂乐|节奏蓝调/i,"乡村":/\bcountry\b|乡村音乐/i,"民谣":/\bfolk\b|民谣|\bacoustic\b/i,"蓝调":/\bblues\b|蓝调/i,"雷鬼":/reggae|雷鬼/i,"金属":/\bmetal\b|金属乐|heavy\s*metal/i,"拉丁":/\blatin\b|salsa|cumbia|merengue|bachata|拉丁/i,"央广":/央广|中央人民广播|中国之声|CNR\s*\d|CRI\b|中国国际广播|全国联播|中央广播电台/i,"央视":/央视|CCTV|中央电视台/i},typeKeys=Object.keys(typePatterns),provincePatterns={"全国":/央广|中央人民广播|中国之声|CNR\s*\d|CRI\b|中国国际广播|全国联播|中央广播电台/i,"北京":/北京|Beijing|Peking|Peiping|Peiking/i,"天津":/天津|Tianjin|Tientsin|Tientsien/i,"上海":/上海|Shanghai/i,"重庆":/重庆|Chongqing|Chungking|Chunking/i,"广东":/广东|珠江|Guangdong|Kwangtung|广州|深圳|珠海|汕头|佛山|韶关|湛江|肇庆|江门|茂名|惠州|梅州|汕尾|河源|阳江|清远|东莞|中山|潮州|揭阳|云浮|Guangzhou|Canton|Kwangchow|Shenzhen|Shumchun|Zhuhai|Shantou|Swatow|Foshan|Fatshan|Shaoguan|Shaokwan|Zhanjiang|Tsamkong|Chanchiang|Zhaoqing|Shiuhing|Jiangmen|Kongmoon|Maoming|Huizhou|Meizhou|Kaying|Shanwei|Heyuan|Yangjiang|Qingyuan|Dongguan|Zhongshan|Chaozhou|Chaochow|Jieyang|Yunfu/i,"广西":/广西|Guangxi|Kwangsi|南宁|柳州|桂林|梧州|北海|防城港|钦州|贵港|玉林|百色|贺州|河池|来宾|崇左|Nanning|Liuzhou|Liuchow|Guilin|Kweilin|Wuzhou|Beihai|Fangchenggang|Qinzhou|Guigang|Yulin|Baise|Hezhou|Hechi|Laibin|Chongzuo/i,"海南":/海南(?!州)|Hainan|海口|三亚|三沙|儋州|琼海|文昌|万宁|Haikou|Hoihow|Haikkow|Sanya|Danzhou|Qionghai|Wenchang|Wanning/i,"福建":/福建|闽南|闽北|闽东|闽西|Fujian|Fukien|福州|厦门|莆田|三明|泉州|漳州|南平|龙岩|宁德|Fuzhou|Foochow|Xiamen|Amoy|Putian|Hinghwa|Sanming|Quanzhou|Chinchew|Tsinkiang|Zhangzhou|Changchow|Cheangchew|Nanping|Longyan|Ningde/i,"江苏":/江苏|Jiangsu|Kiangsu|南京|无锡|徐州|常州|苏州|南通|连云港|淮安|盐城|扬州|镇江|泰州|宿迁|Nanjing|Nanking|Wuxi|Wusih|Xuzhou|Hsuchow|Suchow|Changzhou|Suzhou|Soochow|Nantong|Nantung|Lianyungang|Lienyunkang|Huaian|Yancheng|Yangzhou|Yangchow|Zhenjiang|Chinkiang|Taizhou|Suqian/i,"浙江":/浙江|Zhejiang|Chekiang|杭州|宁波|温州|嘉兴|湖州|绍兴|金华|衢州|舟山|台州|丽水|Hangzhou|Hangchow|Ningbo|Ningpo|Wenzhou|Wenchow|Jiaxing|Kashing|Huzhou|Huchow|Shaoxing|Shaohsing|Jinhua|Quzhou|Zhoushan|Lishui/i,"山东":/山东|Shandong|Shantung|济南|青岛|淄博|枣庄|东营|烟台|潍坊|济宁|泰安|威海|日照|临沂|德州|聊城|滨州|菏泽|Jinan|Tsinan|Chinan|Qingdao|Tsingtao|Chingtao|Zibo|Zaozhuang|Dongying|Yantai|Chefoo|Yentai|Weifang|Jining|Taian|Weihai|Weihaiwei|Rizhao|Linyi|Dezhou|Liaocheng|Binzhou|Heze/i,"安徽":/安徽|Anhui|Anhwei|Nganhwei|合肥|芜湖|蚌埠|淮南|马鞍山|淮北|铜陵|安庆|黄山|滁州|阜阳|宿州|六安|宣城|池州|亳州|Hefei|Hofei|Wuhu|Bengbu|Pengpu|Huainan|Maanshan|Huaibei|Tongling|Anqing|Anking|Huangshan|Chuzhou|Fuyang|Luan|Xuancheng|Chizhou|Bozhou/i,"江西":/江西|Jiangxi|Kiangsi|南昌|景德镇|萍乡|九江|新余|鹰潭|赣州|吉安|宜春|抚州|上饶|Nanchang|Jingdezhen|Kingtehchen|Pingxiang|Jiujiang|Kiukiang|Xinyu|Yingtan|Ganzhou|Jian|Yichun|Fuzhou|Shangrao/i,"湖南":/湖南|Hunan|长沙|株洲|湘潭|衡阳|邵阳|岳阳|常德|张家界|益阳|郴州|永州|怀化|娄底|湘西|Changsha|Zhuzhou|Xiangtan|Siangtan|Hengyang|Shaoyang|Yueyang|Yochow|Changde|Zhangjiajie|Yiyang|Chenzhou|Yongzhou|Huaihua|Loudi|Xiangxi/i,"湖北":/湖北|Hubei|Hupeh|Hupei|武汉|黄石|十堰|宜昌|襄阳|鄂州|荆门|孝感|荆州|黄冈|咸宁|随州|恩施|仙桃|潜江|天门|Wuhan|Wuchang|Hankow|Hankou|Hanyang|Huangshi|Shiyan|Yichang|Ichang|Xiangyang|Siangyang|Ezhou|Jingmen|Xiaogan|Jingzhou|Shashi|Huanggang|Xianning|Suizhou|Enshi|Xiantao|Qianjiang|Tianmen/i,"河南":/河南|Henan|Honan|郑州|开封|洛阳|平顶山|安阳|鹤壁|新乡|焦作|濮阳|许昌|漯河|三门峡|南阳|商丘|信阳|周口|驻马店|Zhengzhou|Chengchow|Kaifeng|Luoyang|Loyang|Pingdingshan|Anyang|Hebi|Xinxiang|Jiaozuo|Puyang|Xuchang|Luohe|Sanmenxia|Nanyang|Shangqiu|Xinyang|Zhoukou|Zhumadian/i,"河北":/河北|Hebei|Hopeh|Hopei|石家庄|唐山|秦皇岛|邯郸|邢台|保定|张家口|承德|沧州|廊坊|衡水|Shijiazhuang|Shihkiachwang|Shichiachiang|Tangshan|Qinhuangdao|Handan|Xingtai|Baoding|Paoting|Zhangjiakou|Kalgan|Changchiakow|Chengde|Cangzhou|Langfang|Hengshui/i,"山西":/山西|Shanxi|Shansi|太原|大同|阳泉|长治|晋城|朔州|晋中|运城|忻州|临汾|吕梁|Taiyuan|Datong|Tatung|Yangquan|Changzhi|Jincheng|Shuozhou|Jinzhong|Yuncheng|Xinzhou|Linfen|Luliang/i,"辽宁":/辽宁|Liaoning|沈阳|大连|鞍山|抚顺|本溪|丹东|锦州|营口|阜新|辽阳|盘锦|铁岭|朝阳|葫芦岛|Shenyang|Mukden|Fengtien|Dalian|Dairen|Talien|Anshan|Fushun|Benxi|Dandong|Antung|Jinzhou|Chinchow|Yingkou|Fuxin|Liaoyang|Panjin|Tieling|Chaoyang|Huludao/i,"吉林":/吉林|Jilin|Kirin|Chilin|长春|四平|辽源|通化|白山|松原|白城|延边|Changchun|Hsinking|Siping|Liaoyuan|Tonghua|Baishan|Songyuan|Baicheng|Yanbian/i,"黑龙江":/黑龙江|Heilongjiang|Heilungkiang|哈尔滨|齐齐哈尔|鸡西|鹤岗|双鸭山|大庆|伊春|佳木斯|七台河|牡丹江|黑河|绥化|大兴安岭|Harbin|Qiqihar|Tsitsihar|Chichihaerh|Jixi|Hegang|Shuangyashan|Daqing|Yichun|Jiamusi|Chiamussu|Qitaihe|Mudanjiang|Mutankiang|Heihe|Suihua|Daxinganling/i,"四川":/四川|Sichuan|Szechwan|Szechuan|成都|自贡|攀枝花|泸州|德阳|绵阳|广元|遂宁|内江|乐山|南充|眉山|宜宾|广安|达州|雅安|巴中|资阳|阿坝|甘孜|凉山|Chengdu|Chengtu|Zigong|Panzhihua|Luzhou|Luchow|Deyang|Mianyang|Mienchiang|Guangyuan|Suining|Neijiang|Leshan|Kiating|Nanchong|Nanchung|Meishan|Yibin|Ipin|Guangan|Dazhou|Yaan|Bazhong|Ziyang|Aba|Ganzi|Liangshan/i,"贵州":/贵州|Guizhou|Kweichow|贵阳|六盘水|遵义|安顺|毕节|铜仁|黔西南|黔东南|黔南|Guiyang|Kweiyang|Liupanshui|Zunyi|Tsunyi|Anshun|Bijie|Tongren|Qianxinan|Qiandongnan|Qiannan/i,"云南":/云南|Yunnan|昆明|曲靖|玉溪|保山|昭通|丽江|普洱|临沧|楚雄|红河|文山|西双版纳|大理|德宏|怒江|迪庆|Kunming|Yunnanfu|Qujing|Yuxi|Baoshan|Zhaotong|Lijiang|Likiang|Puer|Lincang|Chuxiong|Honghe|Wenshan|Xishuangbanna|Dali|Tali|Dehong|Nujiang|Diqing/i,"西藏":/西藏|Tibet|藏语|拉萨|日喀则|昌都|林芝|山南|那曲|阿里|Lhasa|Lasa|Shigatse|Xigazê|Chamdo|Changdu|Nyingchi|Linzhi|Shannan|Nagqu|Naqu/i,"陕西":/陕西|Shaanxi|Shensi|西安|铜川|宝鸡|咸阳|渭南|延安|汉中|榆林|安康|商洛|Xian|Xi.an|Sian|Hsian|Sianfu|Tongchuan|Baoji|Paochi|Xianyang|Hsienyang|Weinan|Yanan|Yenan|Hanzhong|Hanchung|Yulin|Ankang|Shangluo/i,"甘肃":/甘肃|Gansu|Kansu|兰州|嘉峪关|金昌|白银|天水|武威|张掖|平凉|酒泉|庆阳|定西|陇南|临夏|甘南|Lanzhou|Lanchow|Jiayuguan|Jinchang|Baiyin|Tianshui|Tienshui|Wuwei|Liangchow|Zhangye|Changyeh|Pingliang|Jiuquan|Chiuchuan|Qingyang|Dingxi|Longnan|Linxia|Gannan/i,"青海":/青海|Qinghai|Tsinghai|Chinghai|西宁|海东|海北|黄南|海南州|果洛|玉树|Xining|Sining|Haidong|Haibei|Huangnan|Hainanzhou|Guoluo|Yushu/i,"新疆":/新疆|Xinjiang|Sinkiang|维吾尔|乌鲁木齐|克拉玛依|吐鲁番|哈密|昌吉|博尔塔拉|巴音郭楞|阿克苏|克孜勒苏|喀什|和田|伊犁|塔城|阿勒泰|Urumqi|Urumchi|Wulumuqi|Karamay|Turpan|Tulufan|Hami|Changji|Bortala|Boertala|Bayingolin|Bayinguoleng|Aksu|Akesu|Kizilsu|Kashgar|Kashi|Hotan|Hetian|Khotan|Ili|Yili|Tacheng|Altay|Aletai/i,"宁夏":/宁夏|Ningxia|Ningsia|银川|石嘴山|吴忠|固原|中卫|Yinchuan|Shizuishan|Wuzhong|Guyuan|Zhongwei/i,"内蒙古":/内蒙古|内蒙|呼和浩特|包头|乌海|赤峰|通辽|鄂尔多斯|呼伦贝尔|巴彦淖尔|乌兰察布|兴安盟|锡林郭勒|阿拉善|蒙古语|Hohhot|Huhehaote|Kweisui|Kweihua|Suiyuan|Baotou|Paotow|Wuhai|Chifeng|Tongliao|Ordos|Eerduosi|Hulunbuir|Hulunbeier|Bayannur|Ulanqab|Wulanchabu|Hinggan|Xingan|Xilingol|Xilinguole|Alxa|Alasha/i};function detectProvince(n){for(const[a,e]of Object.entries(provincePatterns))if(e.test(n))return a;return"其他"}const T2S_PAIRS="電电廣广臺台灣湾國国語语樂乐聽听聞闻節节體体聯联頻频粵粤鳳凤閩闽衛卫娛娱兒儿時时藝艺經经綜综總总發发傳传興兴會会來来為为當当進进長长開开關关東东風风愛爱聲声話话見见號号陽阳業业際际與与個个們们無无網网訊讯線线頭头動动車车萬万問问題题員员點点書书學学習习導导親亲實实歡欢雲云務务優优麗丽農农濟济環环夢梦島岛億亿說说讀读寫写還还兩两橋桥飛飞遠远遊游運运龍龙馬马魚鱼鳥鸟畫画歷历參参義义專专權权產产術术設设備备試试驗验應应響响壓压質质標标達达請请項项紅红綠绿藍蓝純纯維维積积編编繼继給给結结絕绝視视報报後后廳厅銀银鐘钟論论錄录類类齊齐鬥斗頂顶",T2S_MAP={};for(let n=0;268>n;n+=2)T2S_MAP[T2S_PAIRS[n]]=T2S_PAIRS[n+1];function normalizeZh(n){return n.replace(/[\u4e00-\u9fff]/g,n=>T2S_MAP[n]||n)}function preprocessNewStations(n){n.forEach(n=>{const a=normalizeZh(n.name);if(n._nameLower=a.toLowerCase(),n._types=typeKeys.filter(n=>typePatterns[n].test(a)),"中国"===n.region){const e=detectProvince(a);"其他"!==e&&n._types.unshift(e)}0===n._types.length&&(n._types=["其他"])})}function preprocessStations(n){preprocessNewStations(allStations=n)}const BATCH_SIZE=100;let currentRegion="all",currentType="",currentSearch="",visibleCount=100,isLoading=!1,currentUrl="",currentStation=null,stationsFullyLoaded=!1,isManuallyStopped=!1,cachedStationTotal=0,currentLang="en",i18n={},showFavoritesOnly=!1,favorites=[];const SUPPORTED_LANGS=["zh-CN","zh-TW","en","es","fr","de","it","ja","ko","ru"],LABEL_KEYS={"中国":"china","日本":"japan","韩国":"korea","台湾":"taiwan","香港":"hongkong","新加坡":"singapore","英国":"uk","德国":"germany","法国":"france","意大利":"italy","西班牙":"spain","俄罗斯":"russia","美国":"usa","加拿大":"canada","澳大利亚":"australia","澳洲":"australia","新西兰":"newzealand","巴西":"brazil","墨西哥":"mexico","阿根廷":"argentina","瑞士":"switzerland","南非":"southafrica","其他":"other","全球":"global","音乐":"music","新闻":"news","综合":"general","交通":"traffic","体育":"sports","文艺":"arts","经典":"classic","儿童":"kids","宗教":"religion","古典":"classical","方言":"dialect","爵士":"jazz","流行":"pop","摇滚":"rock","嘻哈":"hiphop","电子":"electronic","R&B":"rnb","乡村":"country","民谣":"folk","蓝调":"blues","雷鬼":"reggae","金属":"metal","拉丁":"latin","财经":"finance","央广":"cnr","央视":"cctv","全国":"national","北京":"beijing","天津":"tianjin","上海":"shanghai","重庆":"chongqing","广东":"guangdong","广西":"guangxi","海南":"hainan","福建":"fujian","江苏":"jiangsu","浙江":"zhejiang","山东":"shandong","安徽":"anhui","江西":"jiangxi","湖南":"hunan","湖北":"hubei","河南":"henan","河北":"hebei","山西":"shanxi","辽宁":"liaoning","吉林":"jilin","黑龙江":"heilongjiang","四川":"sichuan","贵州":"guizhou","云南":"yunnan","西藏":"tibet","陕西":"shaanxi","甘肃":"gansu","青海":"qinghai","新疆":"xinjiang","宁夏":"ningxia","内蒙古":"innermongolia"},THEME_COLORS={green:"#22c55e",teal:"#14b8a6",cyan:"#06b6d4",orange:"#f97316",amber:"#f59e0b",rose:"#f43f5e",red:"#dc2626",pink:"#ec4899",purple:"#a855f7",indigo:"#6366f1",grayscale:"#888",bw:"#ddd",black:"#ffffff"},THEME_KEYS=["green","teal","cyan","orange","amber","rose","red","pink","purple","indigo","grayscale","bw","black"],LANG_OPTIONS=[{value:"zh-CN",flag:"cn",label:"简体中文"},{value:"zh-TW",flag:"tw",label:"繁體中文"},{value:"en",flag:"gb",label:"English"},{value:"es",flag:"es",label:"Español"},{value:"fr",flag:"fr",label:"Français"},{value:"de",flag:"de",label:"Deutsch"},{value:"it",flag:"it",label:"Italiano"},{value:"ja",flag:"jp",label:"日本語"},{value:"ko",flag:"kr",label:"한국어"},{value:"ru",flag:"ru",label:"Русский"}];function esc(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function isSameStation(n,a){return n&&a&&n.url===a.url&&n.name===a.name}let filteredCache=null;$(function(){function n(n){return favorites.some(a=>a.url===n.url&&a.name===n.name)}function a(){const n=favorites.length,a=h("favOnlyToggle")||"仅显示收藏";$("#favOnlyBtn").attr("title",n>0?a+" ("+n+")":a)}function e(){if(!currentStation)return void $("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").removeClass("fav-active");const a=n(currentStation);$("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").toggleClass("fav-active",a);const e=a?h("favRemove")||"取消收藏":h("favAdd")||"收藏";$("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").attr("title",e)}function t(n){const t=favorites.findIndex(a=>a.url===n.url&&a.name===n.name),o=0>t;o?favorites.push({name:n.name,url:n.url,logo:n.logo||null,region:n.region||"",country:n.country||""}):favorites.splice(t,1),localStorage.setItem("favorites",JSON.stringify(favorites)),a(),$(".station-fav-btn").each(function(){$(this).attr("data-url")===n.url&&$(this).attr("data-name")===n.name&&$(this).toggleClass("fav-active",o).attr("title",o?h("favRemove")||"取消收藏":h("favAdd")||"收藏")}),e(),showFavoritesOnly&&(filteredCache=null,i())}function i(a=!1){if(!allStations.length&&!showFavoritesOnly)return void $("#resultCount").text(h(stationsFullyLoaded?"noStations":"loading"));a&&(filteredCache=null,visibleCount=100);const e=function(){if(filteredCache)return filteredCache;if(showFavoritesOnly){const n=[],a=new Set;return favorites.forEach(e=>{if(a.has(e.name))return;if(a.add(e.name),currentSearch&&!normalizeZh(e.name).toLowerCase().includes(currentSearch))return;const t=allStations.find(n=>n.url===e.url&&n.name===e.name);n.push(t||{name:e.name,url:e.url,logo:e.logo||null,region:e.region||"",country:e.country||"",_types:[],_nameLower:normalizeZh(e.name).toLowerCase(),_invalid:stationsFullyLoaded})}),filteredCache=n,n}const n=[],a=new Set;for(let e=0;allStations.length>e;e++){const t=allStations[e];a.has(t.name)||"all"!==currentRegion&&t.region!==currentRegion||currentSearch&&!t._nameLower.includes(currentSearch)||(""===currentType||t._types.includes(currentType))&&(a.add(t.name),n.push(t))}return filteredCache=n,n}(),t=e.slice(0,visibleCount);if(function(a){let e="";a.forEach(a=>{const t=n(a),i=!!a._invalid,o=a.logo&&"null"!==a.logo?`<img src="${a.logo}" class="station-logo" alt="" loading="lazy">`:`<div class="station-logo placeholder">${SVG_LOGO_SM}</div>`,l=(isSameStation(a,currentStation)&&(()=>{const n=document.getElementById("audioPlayer");return!!n.src&&n.src!==location.href&&!n.paused})()?" playing":"")+(i?" station-invalid":"");let s="";a.country&&(s=`<span class="region-tag"><img src="https://flagcdn.com/w20/${regionCodes[a.country]||"un"}.png" alt="" class="region-tag-flag"><span class="region-tag-name">${esc(d(a.country))}</span></span>`);const r=(a._types||[]).map(n=>`<span class="type-tag">${esc(d(n))}</span>`).join(""),c=i?`<span class="invalid-badge">⚠ ${h("invalidStation")||"失效"}</span>`:"";e+=`<div class="station-card${l}" data-url="${esc(a.url)}" data-name="${esc(a.name)}">\n                        ${o}\n                        <div class="station-content">\n                            <div class="station-name">${esc(a.name)}</div>\n                            <div class="station-meta">\n                                ${s}${r}${c}\n                            </div>\n                        </div>\n                        <div class="station-actions">\n                            <span class="playing-badge"><span class="playing-badge-dot"></span>${h("playerPlaying")||"正在播放"}</span>\n                            <button class="station-fav-btn${t?" fav-active":""}" data-url="${esc(a.url)}" data-name="${esc(a.name)}" title="${t?h("favRemove")||"取消收藏":h("favAdd")||"收藏"}">\n                                ${FAV_HEART_SVG}\n                            </button>\n                            <button class="station-play-btn" data-url="${esc(a.url)}" data-name="${esc(a.name)}" title="${h("playButton")||"播放"}">\n                                <svg viewBox="0 0 24 24"><polygon points="6,4 20,12 6,20"/></svg>\n                            </button>\n                            <button class="station-stop-btn" data-url="${esc(a.url)}" data-name="${esc(a.name)}" title="${h("pauseButton")||"暂停"}">\n                                <svg viewBox="0 0 24 24"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>\n                            </button>\n                        </div>\n                    </div>`}),$("#stationsGrid").html(e)}(t),showFavoritesOnly&&0===e.length){const n=0===favorites.length?h("noFavStations")||"没有收藏的电台":h("noStations")||"无匹配结果";return $("#stationsGrid").html(`<div class="no-results">${n}</div>`),$("#resultCount").text("0 / 0"),void $("#loadingMore").removeClass("show")}const i=stationsFullyLoaded?"":h("loadingSuffix");$("#resultCount").text(h("showingCount",{shown:t.length,total:e.length,suffix:i})),$("#loadingMore").toggleClass("show",e.length>visibleCount)}function o(){const n=function(){const n=[],a=new Set;for(let e=0;allStations.length>e;e++){const t=allStations[e];a.has(t.name)||"all"!==currentRegion&&t.region!==currentRegion||currentSearch&&!t._nameLower.includes(currentSearch)||(a.add(t.name),n.push(t))}return n}(),a={};n.forEach(n=>n._types.forEach(n=>{a[n]=(a[n]||0)+1}));const e=new Set(Object.keys(provincePatterns)),t=new Set(Object.keys(typePatterns)),i=["全国","央广","央视"];let o;if("中国"===currentRegion){const n=i.filter(n=>a[n]),l=Object.keys(a).filter(n=>e.has(n)&&!i.includes(n)&&"其他"!==n).sort((n,e)=>a[e]-a[n]),s=Object.keys(a).filter(n=>t.has(n)&&!i.includes(n)&&"其他"!==n).sort((n,e)=>a[e]-a[n]);o=[...n,...l,...s,...a["其他"]?["其他"]:[]]}else o=Object.keys(a).filter(n=>"其他"!==n&&!e.has(n)).sort((n,e)=>a[e]-a[n]),a["其他"]&&o.push("其他");let l=`<button class="type-btn ${""===currentType?"active":""}" data-type="">${h("all")}</button>`;o.forEach(n=>{l+=`<button class="type-btn ${currentType===n?"active":""}" data-type="${n}">${d(n)}(${a[n]})</button>`}),$("#typeBtns").html(l)}function l(){const n=new Set;let a=0;const e={},t={};allStations.forEach(i=>{n.has(i.name)||(n.add(i.name),a++),t[i.region]||(t[i.region]=new Set),t[i.region].has(i.name)||(t[i.region].add(i.name),e[i.region]=(e[i.region]||0)+1)}),$('.region-btn[data-region="all"]').data("count",a),Object.entries(e).forEach(([n,a])=>{$(`.region-btn[data-region="${n}"]`).data("count",a)}),cachedStationTotal=a,p(),$("#totalSubtitle").text(h("totalStations",{total:a}))}function s(n,a=!0){currentUrl=n.url,currentStation=n,localStorage.setItem("play_url",n.url),localStorage.setItem("play_name",n.name),e();const t=document.getElementById("audioPlayer");$("#playerTitle, #fullscreenTitle").text(n.name),function(){if(!currentStation)return;const n=currentStation.logo&&"null"!==currentStation.logo?currentStation.logo:null,a=$("#miniPlayerLogo");n?a.removeClass("placeholder").html('<img src="'+n+'" alt="">'):a.addClass("placeholder").html(SVG_LOGO_SM),$("#miniPlayerName").text(currentStation.name),_()}();const i=n.logo&&"null"!==n.logo?n.logo:null;$("#playerLogo").replaceWith(i?`<img src="${i}" class="player-logo" id="playerLogo" alt="">`:`<div class="player-logo placeholder" id="playerLogo">${SVG_LOGO_MD}</div>`),i?$("#fullscreenCover").replaceWith(`<img src="${i}" class="fullscreen-cover" id="fullscreenCover" alt="">`):$("#fullscreenCover").replaceWith(`<div class="fullscreen-cover placeholder" id="fullscreenCover">${SVG_LOGO_LG}</div>`),$(".station-card").removeClass("playing"),a&&$(".station-card").filter(function(){return $(this).attr("data-url")===n.url&&$(this).attr("data-name")===n.name}).addClass("playing"),a?($("#playerStatus, #fullscreenStatus").text(h("playerLoading")),$("#statusDot, #fullscreenDot").removeClass("playing paused"),t.src=n.url,t.play().catch(n=>{console.warn("自动播放被阻止，请点击播放条开始播放:",n),$("#playerStatus, #fullscreenStatus").text(h("playerClickToPlay")),$("#statusDot, #fullscreenDot").addClass("paused"),r(!0),C(!0)})):($("#playerStatus, #fullscreenStatus").text(h("playerClickToPlay")),$("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),r(!0),C(!0)),g()}function r(n){const a=n?'<polygon points="6,4 20,12 6,20"/>':'<rect x="5" y="4" width="4" height="16"/><rect x="15" y="4" width="4" height="16"/>';$("#playIcon").html(a)}function c(){if(!currentStation)return;const n=document.getElementById("audioPlayer");n.src&&n.src!==window.location.href||(n.src=currentStation.url),n.paused?n.play().catch(n=>console.warn("播放失败:",n)):(isManuallyStopped=!0,n.pause(),n.src="",$("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),$("#playerStatus, #fullscreenStatus").text(h("playerClickToPlay")),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),r(!0),C(!0),$(".station-card").removeClass("playing"),j(!0),$("#miniPlayerStatus").text(h("playerPaused")||"已暂停"),document.title=h("appTitle"))}function u(){$("#regionFilterLabel").text("· "+("all"!==currentRegion?d(currentRegion):h("all"))),$("#typeFilterLabel").text("· "+(""!==currentType?d(currentType):h("all")))}function g(){const n=new URLSearchParams;"all"!==currentRegion&&n.set("region",currentRegion),""!==currentType&&n.set("type",currentType),showFavoritesOnly&&n.set("fav","1"),currentStation&&(n.set("play",currentStation.url),n.set("play_name",currentStation.name)),history.replaceState(null,"",n.toString()?"?"+n:location.pathname)}function h(n,a={}){return String(i18n[n]||n).replace(/\{\{(\w+)\}\}/g,(n,e)=>a[e]??"")}function d(n){const a=LABEL_KEYS[n]||n;return i18n.labels&&i18n.labels[a]?i18n.labels[a]:n}function p(){$(".region-btn").each(function(){const n=$(this).data("region"),a=$(this).data("count"),e=$(this).data("flag-code")||"un",t="all"===n?h("all"):d(n),i=void 0!==a?"("+a+")":"";$(this).html(`<img src="https://flagcdn.com/w20/${e}.png" alt="" class="region-flag"> ${t}${i}`)})}function m(n){return fetch(`lang/${n}.json`,{cache:"no-cache"}).then(n=>{if(!n.ok)throw new Error("Locale not found");return n.json()}).then(a=>{i18n=a,currentLang=n,function(){if($("[data-i18n]").each(function(){const n=$(this).data("i18n"),a=$(this),e=a.children().detach();a.text(h(n)),a.append(e)}),$("[data-i18n-placeholder]").each(function(){const n=$(this).data("i18n-placeholder");$(this).attr("placeholder",h(n))}),$("[data-i18n-title]").each(function(){const n=$(this).data("i18n-title");$(this).attr("title",h(n))}),stationsFullyLoaded?$("#totalSubtitle").text(h("totalStations",{total:cachedStationTotal})):$("#totalSubtitle").text(h("subtitleLoading")),function(){const n=THEME_KEYS.map(n=>{const a="bw"===n?"themeBW":"grayscale"===n?"themeGrayscale":"theme"+n.charAt(0).toUpperCase()+n.slice(1);return`<div class="theme-item${n===($("html").attr("data-theme")||"green")?" active":""}" data-theme="${n}"><span class="theme-item-dot" style="background:${THEME_COLORS[n]}"></span><span>${h(a)}</span></div>`}).join("");$("#themePanel").html(n)}(),y($("html").attr("data-theme")||"green"),f(currentLang),$("#themePickerBtn").attr("aria-label",h("theme")),$("#langPickerBtn").attr("aria-label",h("language")),u(),i(),p(),stationsFullyLoaded&&o(),currentStation){$("#playerTitle, #fullscreenTitle").text(currentStation.name),$("#miniPlayerName").text(currentStation.name),document.title=currentStation.name+" — "+h("appTitle");const n=document.getElementById("audioPlayer");let a,e;n.error?(a="playerError",e="playerError"):n.paused?(a="playerClickToPlay",e="playerPaused"):(a="playerPlaying",e="playerPlaying"),$("#playerStatus, #fullscreenStatus").text(h(a)),$("#miniPlayerStatus").text(h(e))}else document.title=h("appTitle"),$("#fullscreenStatus").text(h("playerWaiting"));e()}()}).catch(()=>{if("en"!==n)return m("en")})}function y(n){$("#themePickerDot").css("background",THEME_COLORS[n]||THEME_COLORS.green);const a="bw"===n?"themeBW":"grayscale"===n?"themeGrayscale":"theme"+n.charAt(0).toUpperCase()+n.slice(1);$("#themePickerLabel").text(h(a)),$("#themePanel .theme-item").removeClass("active").filter(`[data-theme="${n}"]`).addClass("active")}function f(n){const a=LANG_OPTIONS.find(a=>a.value===n)||LANG_OPTIONS[0];$("#langPickerFlag").attr("src",`https://flagcdn.com/w20/${a.flag}.png`),$("#langPickerLabel").text(a.label),$("#langPanel .lang-item").removeClass("active").filter(`[data-lang="${n}"]`).addClass("active")}function v(n){$("html").attr("data-theme",n),localStorage.setItem("theme",n),y(n)}let S;function C(n){const a=n?'<polygon points="8,5 19,12 8,19"/>':'<rect x="7" y="5" width="3" height="14"/><rect x="14" y="5" width="3" height="14"/>';$("#fullscreenPlayBtn svg").html(a)}$("#stationsGrid").on("click",".station-card",function(){const n=$(this).attr("data-url"),a=$(this).attr("data-name"),e=allStations.find(a?e=>e.url===n&&e.name===a:a=>a.url===n);e&&s(e)}),$("#regionBtns").on("click",".region-btn",function(){var n;n=$(this).attr("data-region"),currentRegion=n,currentType="",localStorage.setItem("region",n),localStorage.removeItem("type"),$(".region-btn").removeClass("active"),$(`.region-btn[data-region="${n}"]`).addClass("active"),o(),i(!0),g(),u()}),$("#typeBtns").on("click",".type-btn",function(){var n;n=$(this).attr("data-type"),currentType=n,localStorage.setItem("type",n),o(),i(!0),g(),u()}),$("#favOnlyBtn").on("click",function(){var n;showFavoritesOnly=n=!showFavoritesOnly,localStorage.setItem("favOnly",n?"1":"0"),$("#favOnlyBtn").toggleClass("active",n),$("body").toggleClass("fav-only-mode",n),filteredCache=null,i(!0),g()}),$("#stationsGrid").on("click",".station-fav-btn",function(n){n.stopPropagation();const a=$(this).attr("data-url"),e=$(this).attr("data-name");let i=allStations.find(e?n=>n.url===a&&n.name===e:n=>n.url===a);if(!i){const n=favorites.find(n=>n.url===a&&n.name===e);n&&(i={name:n.name,url:n.url,logo:n.logo||null,region:n.region||"",country:n.country||""})}i&&t(i)}),$("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").on("click",function(){currentStation&&t(currentStation)}),function(){const n=LANG_OPTIONS.map(n=>`<div class="lang-item${n.value===currentLang?" active":""}" data-lang="${n.value}"><img src="https://flagcdn.com/w20/${n.flag}.png" alt=""><span>${n.label}</span></div>`).join("");$("#langPanel").html(n)}(),f(currentLang),$("#themePickerBtn").on("click",function(n){n.stopPropagation();const a=$("#themePickerWrap"),e=a.hasClass("open");$(".picker-wrap").removeClass("open"),e||a.addClass("open")}),$("#langPickerBtn").on("click",function(n){n.stopPropagation();const a=$("#langPickerWrap"),e=a.hasClass("open");$(".picker-wrap").removeClass("open"),e||a.addClass("open")}),$(document).on("click",".theme-item",function(n){n.stopPropagation(),v($(this).data("theme")),$(".picker-wrap").removeClass("open")}),$(document).on("click",".lang-item",function(n){var a;n.stopPropagation(),a=$(this).data("lang"),SUPPORTED_LANGS.includes(a)&&(localStorage.setItem("language",a),m(a)),$(".picker-wrap").removeClass("open")}),$(document).on("click",".picker-panel",function(n){n.stopPropagation()}),$(document).on("click",function(){$(".picker-wrap").removeClass("open")}),$("#regionsToggle").on("click",function(){$("#regionsContent").toggleClass("collapsed"),$(this).find(".toggle-icon").toggleClass("collapsed")}),$("#typesToggle").on("click",function(){$("#typesContent").toggleClass("collapsed"),$(this).find(".toggle-icon").toggleClass("collapsed")}),$("#searchInput").on("input",function(){clearTimeout(S),S=setTimeout(()=>{currentSearch=normalizeZh($(this).val().toLowerCase()),i(!0)},300)}),function(){const n=document.getElementById("loadingMore");n&&new IntersectionObserver(function(n){n[0].isIntersecting&&(isLoading||(isLoading=!0,visibleCount+=100,i(),isLoading=!1))},{rootMargin:"200px"}).observe(n)}(),$("#audioPlayer").on("play",function(){$("#statusDot, #fullscreenDot").removeClass("paused").addClass("playing"),$("#playerStatus, #fullscreenStatus").text(h("playerPlaying")),j(!1),$("#miniPlayerStatus").text(h("playerPlaying")),$("#soundWave").addClass("playing"),$("#fullscreenCover").addClass("playing"),r(!1),C(!1),currentStation&&($(".station-card").removeClass("playing").filter(function(){return $(this).attr("data-url")===currentStation.url&&$(this).attr("data-name")===currentStation.name}).addClass("playing"),document.title=currentStation.name+" — "+h("appTitle"))}).on("pause",function(){$("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),$("#playerStatus, #fullscreenStatus").text(h("playerClickToPlay")),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),r(!0),C(!0),$(".station-card").removeClass("playing"),j(!0),$("#miniPlayerStatus").text(h("playerPaused")||"已暂停"),document.title=h("appTitle")}).on("error",function(){isManuallyStopped?isManuallyStopped=!1:($("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),$("#playerStatus, #fullscreenStatus").text(h("playerError")),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),r(!0),C(!0),$(".station-card").removeClass("playing"),_(),$("#miniPlayerStatus").text(h("playerError")),console.error("音频加载错误"))}),$("#playerBar").on("click",function(n){$(n.target).closest("audio, .fullscreen-btn").length||c()});let b=!1,w=null,k=!1,P=!1,x=!1,T=null;async function L(){if("wakeLock"in navigator)try{T=await navigator.wakeLock.request("screen"),T.addEventListener("release",()=>{T=null})}catch(n){}}function z(){T&&(T.release(),T=null)}function H(){$("#fullscreenPlayer").addClass("show"),function(){if(!currentStation)return;$("#fullscreenTitle").text(currentStation.name);const n=currentStation.logo&&"null"!==currentStation.logo?currentStation.logo:null;n?$("#fullscreenCover").replaceWith(`<img src="${n}" class="fullscreen-cover" id="fullscreenCover" alt="">`):$("#fullscreenCover").replaceWith(`<div class="fullscreen-cover placeholder" id="fullscreenCover">${SVG_LOGO_LG}</div>`),document.getElementById("audioPlayer").paused||($("#fullscreenCover").addClass("playing"),$("#soundWave").addClass("playing"))}();const n=window.scrollY;$("body").css({overflow:"hidden",position:"fixed",top:-n+"px",width:"100%"}),$("body").data("scroll-y",n),L(),O(),w||(w=setInterval(O,1e3))}function B(){$("#fullscreenPlayer").removeClass("show");const n=$("body").data("scroll-y")||0;$("body").css({overflow:"",position:"",top:"",width:""}),window.scrollTo(0,n),b=!1,x=!1,z(),w&&(clearInterval(w),w=null),(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement)&&(document.exitFullscreen||document.webkitExitFullscreen||document.mozCancelFullScreen||function(){}).call(document)}function E(){const n=document.documentElement,a=n.requestFullscreen||n.webkitRequestFullscreen||n.mozRequestFullScreen||n.msRequestFullscreen;a&&a.call(n).catch(()=>{})}function F(){const n=window.matchMedia("(max-width: 900px) and (orientation: landscape) and (max-height: 500px) and (hover: none) and (pointer: coarse)").matches;if(n&&!k)P=!1,$("#fullscreenPlayer").hasClass("show")||(b=!0,H()),x=!0,setTimeout(function(){!$("#fullscreenPlayer").hasClass("show")||document.fullscreenElement||document.webkitFullscreenElement||E()},300);else if(!n&&(P=!1,x=!1,$("#fullscreenPlayer").hasClass("show")&&b)){b=!1,$("#fullscreenPlayer").removeClass("show");const n=$("body").data("scroll-y")||0;$("body").css({overflow:"",position:"",top:"",width:""}),window.scrollTo(0,n),z(),(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement)&&(document.exitFullscreen||document.webkitExitFullscreen||document.mozCancelFullScreen||function(){}).call(document)}k=n}function O(){const n=new Date,a=String(n.getHours()).padStart(2,"0"),e=String(n.getMinutes()).padStart(2,"0"),t=String(n.getSeconds()).padStart(2,"0");$("#fullscreenClock").text(a+":"+e+":"+t)}function _(){currentStation?$("#miniPlayer").addClass("has-station"):$("#miniPlayer").removeClass("has-station")}function j(n){const a=n?'<polygon points="6,4 20,12 6,20"/>':'<rect x="5" y="4" width="4" height="16"/><rect x="15" y="4" width="4" height="16"/>';$("#miniPlayIcon").html(a)}document.addEventListener("visibilitychange",function(){"visible"===document.visibilityState&&$("#fullscreenPlayer").hasClass("show")&&L()}),$("#fullscreenPlayer").on("touchstart.fspend pointerdown.fspend",function(){x&&$("#fullscreenPlayer").hasClass("show")&&!document.fullscreenElement&&!document.webkitFullscreenElement&&(x=!1,E())}),$("#fullscreenBtn").on("click",function(n){n.stopPropagation(),b=!1,P=!1,H(),setTimeout(()=>E(),100)}),$("#fullscreenClose").on("click",function(){P=!0,B()}),$("#fullscreenPlayBtn").on("click",c),$(document).on("keydown",function(n){"Escape"===n.key&&$("#fullscreenPlayer").hasClass("show")&&(P=!0,B())}),$(window).on("orientationchange resize",F),$(document).on("fullscreenchange webkitfullscreenchange mozfullscreenchange",function(){if(!document.fullscreenElement&&!document.webkitFullscreenElement&&!document.mozFullScreenElement&&$("#fullscreenPlayer").hasClass("show")){P=!0,b=!1,$("#fullscreenPlayer").removeClass("show");const n=$("body").data("scroll-y")||0;$("body").css({overflow:"",position:"",top:"",width:""}),window.scrollTo(0,n),z()}}),F(),$(window).on("scroll.backtotop",function(){$(this).scrollTop()>300?($("#miniPlayer").addClass("show"),$("body").addClass("mini-player-visible")):($("#miniPlayer").removeClass("show"),$("body").removeClass("mini-player-visible"))}),$("#backToTop").on("click",function(){$("html, body").animate({scrollTop:0},300)}),$("#miniPlayBtn").on("click",function(){c()}),$("#miniFullscreenBtn").on("click",function(n){n.stopPropagation(),b=!1,P=!1,H(),setTimeout(()=>E(),100)}),$(document).on("click",".station-play-btn",function(n){n.stopPropagation();const a=$(this).attr("data-url"),e=$(this).attr("data-name"),t=allStations.find(e?n=>n.url===a&&n.name===e:n=>n.url===a);t&&s(t)}),$(document).on("click",".station-stop-btn",function(n){n.stopPropagation();const a=document.getElementById("audioPlayer");isManuallyStopped=!0,a.pause(),a.src="",currentUrl="",_(),e(),i(),currentStation&&($("#playerStatus").text(h("playerClickToPlay")||"点击播放"),$("#miniPlayerStatus").text(h("playerPaused")||"已暂停"),$("#fullscreenStatus").text(h("playerClickToPlay")||"点击播放")),$("#statusDot").removeClass("playing").addClass("paused"),$("#fullscreenDot").removeClass("playing").addClass("paused"),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),r(!0),C(!0),j(!0)}),function(){const n=localStorage.getItem("language"),a=navigator.languages&&navigator.languages[0]||navigator.language||"en",e=a.startsWith("zh-TW")||a.startsWith("zh-HK")||a.startsWith("zh-MO")?"zh-TW":a.startsWith("zh")?"zh-CN":a.startsWith("es")?"es":a.startsWith("fr")?"fr":a.startsWith("de")?"de":a.startsWith("it")?"it":a.startsWith("ja")?"ja":a.startsWith("ko")?"ko":a.startsWith("ru")?"ru":"en",t=n||e,i=SUPPORTED_LANGS.includes(t)?t:"en";return n&&n===i||localStorage.setItem("language",i),m(i)}().then(()=>{v(localStorage.getItem("theme")||"green"),function(){const n=new URLSearchParams(location.search),e=n.get("region"),t=n.get("type"),r=localStorage.getItem("region")||"all",c=localStorage.getItem("type")||"";!function(){try{const n=localStorage.getItem("favorites");n&&(favorites=JSON.parse(n)),Array.isArray(favorites)||(favorites=[])}catch(n){favorites=[]}}(),a();const d=n.get("fav"),p=localStorage.getItem("favOnly");("1"===d||!d&&"1"===p)&&(showFavoritesOnly=!0,$("#favOnlyBtn").addClass("active"),$("body").addClass("fav-only-mode"),"1"===d&&localStorage.setItem("favOnly","1")),currentRegion=e||r,"all"!==currentRegion&&($(".region-btn").removeClass("active"),$(`.region-btn[data-region="${currentRegion}"]`).addClass("active")),currentType=t||(r===currentRegion?c:""),e&&(localStorage.setItem("region",currentRegion),t||localStorage.removeItem("type")),t&&localStorage.setItem("type",currentType),e||currentRegion===r||localStorage.setItem("region",currentRegion),t||currentType===c||""===currentType||localStorage.setItem("type",currentType),600>window.innerWidth&&($("#typesContent").addClass("collapsed"),$("#typesToggle").find(".toggle-icon").addClass("collapsed")),u(),$("#resultCount").text(h("loading")),(async()=>{try{const e=await fetch("?action=stations");if(!e.ok)throw new Error("HTTP "+e.status);const t=e.body.getReader(),r=new TextDecoder,c=1e3,u=<?php echo $totalCount; ?>;let d="",p=[],m=!1;const y=$("#topProgressFill"),f=n=>{const a=u>0?Math.min(98,Math.round(n/u*100)):0;y.css("width",a+"%"),$("#totalSubtitle").text(h("loadingStations",{loaded:n.toLocaleString()}))},v=()=>{m||(m=!0,requestAnimationFrame(()=>{m=!1,filteredCache=null,i()}))},S=()=>{p.length&&(preprocessNewStations(p),p.forEach(n=>allStations.push(n)),p=[],f(allStations.length),v())};for(;;){const{done:e,value:u}=await t.read();if(u){d+=r.decode(u,{stream:!0});const n=d.split("\n");d=n.pop();for(const a of n)if(a.trim())try{p.push(JSON.parse(a))}catch(n){}c>p.length||S()}if(e){if(d.trim())try{p.push(JSON.parse(d.trim()))}catch(n){}S(),stationsFullyLoaded=!0,filteredCache=null,i(!0),o(),l(),a(),y.addClass("done");const e=n.get("play")||localStorage.getItem("play_url");if(e){const a=n.get("play_name")||localStorage.getItem("play_name");let t=a?allStations.find(n=>n.url===e&&n.name===a):null;t||(t=allStations.find(n=>n.url===e)),t&&(s(t,!1),n.get("play")||g())}break}}}catch(n){$("#resultCount").text(h("loadFailedRefresh"))}})()}()})});</script>
</body>
</html>