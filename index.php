...
<body>
    ...
    <script>const regionCodes=<?php echo json_encode(array_merge(array_flip(REGION_NAMES), ['其他' => 'un']), JSON_UNESCAPED_UNICODE); ?>;function makeSvgLogo(n,e){return`<svg viewBox="0 0 60 52" width="${n}" height="${e}" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="10" width="44" height="32" rx="12" fill="var(--bg-card)" opacity="0.95" stroke="var(--primary)" stroke-width="1"/><rect x="12" y="14" width="22" height="20" rx="6" fill="var(--bg)"/><rect x="14" y="16" width="18" height="16" rx="5" fill="var(--primary-dim)" opacity="0.85"/><circle cx="25" cy="24" r="9" fill="var(--bg)"/><circle cx="25" cy="24" r="6" fill="var(--primary-dim)"/><circle cx="25" cy="24" r="3" fill="var(--bg)"/><path d="M16 24h18" stroke="var(--bg)" stroke-width="2" stroke-linecap="round"/><rect x="36" y="18" width="10" height="14" rx="3" fill="var(--primary-dim)"/><circle cx="41" cy="25" r="2" fill="var(--bg)"/><line x1="38" y1="21" x2="44" y2="21" stroke="var(--bg)" stroke-width="1.5" stroke-linecap="round"/><line x1="38" y1="29" x2="44" y2="29" stroke="var(--bg)" stroke-width="1.5" stroke-linecap="round"/></svg>`}const SVG_LOGO_SM=makeSvgLogo(36,28),SVG_LOGO_MD=makeSvgLogo(44,38),SVG_LOGO_LG=makeSvgLogo(100,87),FAV_HEART_SVG='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>';var allStations=[];const typePatterns={"音乐":/音乐|Music|pop|rock|hit|jazz|classical/i,"新闻":/新闻|News|资讯|information/i,"财经":/财经|金融|股票|经济|Finance|Financial|Business|Economy|Stock|Market|Investment|Banking/i,"综合":/广播|Radio|综合|general/i,"交通":/交通|Traffic|汽车|Auto/i,"体育":/体育|Sports/i,"文艺":/文艺|Culture/i,"经典":/经典|Classic|怀旧|Old/i,"儿童":/儿童|少儿|Kids|children/i,"宗教":/宗教|上帝|Islam|Christian|Quran|佛教/i,"古典":/古典|Symphony|交响/i,"方言":/方言|闽南|粤语|Cantonese|吴语|沪语/i,"爵士":/jazz|爵士/i,"流行":/\bpop\b|流行|top\s*40|\bhits\b|k.?pop|j.?pop/i,"摇滚":/\brock\b|摇滚|\bindie\b|alternative|punk|grunge/i,"嘻哈":/hip.?hop|\brap\b|嘻哈|说唱/i,"电子":/\bedm\b|\belectronic\b|\belectro\b|techno|trance|dance\s*(?:music|fm|radio|hits)|舞曲|电子音乐/i,"R&B":/\br\s*&\s*b\b|rhythm.?blues|soul\s*(?:music|fm|radio)|灵魂乐|节奏蓝调/i,"乡村":/\bcountry\b|乡村音乐/i,"民谣":/\bfolk\b|民谣|\bacoustic\b/i,"蓝调":/\bblues\b|蓝调/i,"雷鬼":/reggae|雷鬼/i,"金属":/\bmetal\b|金属乐|heavy\s*metal/i,"拉丁":/\blatin\b|salsa|cumbia|merengue|bachata|拉丁/i,"央广":/央广|中央人民广播|中国之声|CNR\s*\d|CRI\b|中国国际广播|全国联播|中央广播电台/i,"央视":/央视|CCTV|中央电视台/i},typeKeys=Object.keys(typePatterns),provincePatterns={"全国":/央广|中央人民广播|中国之声|CNR\s*\d|CRI\b|中国国际广播|全国联播|中央广播电台/i,"北京":/北京|Beijing|Peking|Peiping|Peiking/i,"天津":/天津|Tianjin|Tientsin|Tientsien/i,"上海":/上海|Shanghai/i,"重庆":/重庆|Chongqing|Chungking|Chunking/i,"广东":/广东|珠江|Guangdong|Kwangtung|广州|深圳|珠海|汕头|佛山|韶关|湛江|肇庆|江门|茂名|惠州|梅州|汕尾|河源|阳江|清远|东莞|中山|潮州|揭阳|云浮|Guangzhou|Canton|Kwangchow|Shenzhen|Shumchun|Zhuhai|Shantou|Swatow|Foshan|Fatshan|Shaoguan|Shaokwan|Zhanjiang|Tsamkong|Chanchiang|Zhaoqing|Shiuhing|Jiangmen|Kongmoon|Maoming|Huizhou|Meizhou|Kaying|Shanwei|Heyuan|Yangjiang|Qingyuan|Dongguan|Zhongshan|Chaozhou|Chaochow|Jieyang|Yunfu/i,"广西":/广西|Guangxi|Kwangsi|南宁|柳州|桂林|梧州|北海|防城港|钦州|贵港|玉林|百色|贺州|河池|来宾|崇左|Nanning|Liuzhou|Liuchow|Guilin|Kweilin|Wuzhou|Beihai|Fangchenggang|Qinzhou|Guigang|Yulin|Baise|Hezhou|Hechi|Laibin|Chongzuo/i,"海南":/海南(?!州)|Hainan|海口|三亚|三沙|儋州|琼海|文昌|万宁|Haikou|Hoihow|Haikkow|Sanya|Danzhou|Qionghai|Wenchang|Wanning/i,"福建":/福建|闽南|闽北|闽东|闽西|Fujian|Fukien|福州|厦门|莆田|三明|泉州|漳州|南平|龙岩|宁德|Fuzhou|Foochow|Xiamen|Amoy|Putian|Hinghwa|Sanming|Quanzhou|Chinchew|Tsinkiang|Zhangzhou|Changchow|Cheangchew|Nanping|Longyan|Ningde/i,"江苏":/江苏|Jiangsu|Kiangsu|南京|无锡|徐州|常州|苏州|南通|连云港|淮安|盐城|扬州|镇江|泰州|宿迁|Nanjing|Nanking|Wuxi|Wusih|Xuzhou|Hsuchow|Suchow|Changzhou|Suzhou|Soochow|Nantong|Nantung|Lianyungang|Lienyunkang|Huaian|Yancheng|Yangzhou|Yangchow|Zhenjiang|Chinkiang|Taizhou|Suqian/i,"浙江":/浙江|Zhejiang|Chekiang|杭州|宁波|温州|嘉兴|湖州|绍兴|金华|衢州|舟山|台州|丽水|Hangzhou|Hangchow|Ningbo|Ningpo|Wenzhou|Wenchow|Jiaxing|Kashing|Huzhou|Huchow|Shaoxing|Shaohsing|Jinhua|Quzhou|Zhoushan|Lishui/i,"山东":/山东|Shandong|Shantung|济南|青岛|淄博|枣庄|东营|烟台|潍坊|济宁|泰安|威海|日照|临沂|德州|聊城|滨州|菏泽|Jinan|Tsinan|Chinan|Qingdao|Tsingtao|Chingtao|Zibo|Zaozhuang|Dongying|Yantai|Chefoo|Yentai|Weifang|Jining|Taian|Weihai|Weihaiwei|Rizhao|Linyi|Dezhou|Liaocheng|Binzhou|Heze/i,"安徽":/安徽|Anhui|Anhwei|Nganhwei|合肥|芜湖|蚌埠|淮南|马鞍山|淮北|铜陵|安庆|黄山|滁州|阜阳|宿州|六安|宣城|池州|亳州|Hefei|Hofei|Wuhu|Bengbu|Pengpu|Huainan|Maanshan|Huaibei|Tongling|Anqing|Anking|Huangshan|Chuzhou|Fuyang|Luan|Xuancheng|Chizhou|Bozhou/i,"江西":/江西|Jiangxi|Kiangsi|南昌|景德镇|萍乡|九江|新余|鹰潭|赣州|吉安|宜春|抚州|上饶|Nanchang|Jingdezhen|Kingtehchen|Pingxiang|Jiujiang|Kiukiang|Xinyu|Yingtan|Ganzhou|Jian|Yichun|Fuzhou|Shangrao/i,"湖南":/湖南|Hunan|长沙|株洲|湘潭|衡阳|邵阳|岳阳|常德|张家界|益阳|郴州|永州|怀化|娄底|湘西|Changsha|Zhuzhou|Xiangtan|Siangtan|Hengyang|Shaoyang|Yueyang|Yochow|Changde|Zhangjiajie|Yiyang|Chenzhou|Yongzhou|Huaihua|Loudi|Xiangxi/i,"湖北":/湖北|Hubei|Hupeh|Hupei|武汉|黄石|十堰|宜昌|襄阳|鄂州|荆门|孝感|荆州|黄冈|咸宁|随州|恩施|仙桃|潜江|天门|Wuhan|Wuchang|Hankow|Hankou|Hanyang|Huangshi|Shiyan|Yichang|Ichang|Xiangyang|Siangyang|Ezhou|Jingmen|Xiaogan|Jingzhou|Shashi|Huanggang|Xianning|Suizhou|Enshi|Xiantao|Qianjiang|Tianmen/i,"河南":/河南|Henan|Honan|郑州|开封|洛阳|平顶山|安阳|鹤壁|新乡|焦作|濮阳|许昌|漯河|三门峡|南阳|商丘|信阳|周口|驻马店|Zhengzhou|Chengchow|Kaifeng|Luoyang|Loyang|Pingdingshan|Anyang|Hebi|Xinxiang|Jiaozuo|Puyang|Xuchang|Luohe|Sanmenxia|Nanyang|Shangqiu|Xinyang|Zhoukou|Zhumadian/i,"河北":/河北|Hebei|Hopeh|Hopei|石家庄|唐山|秦皇岛|邯郸|邢台|保定|张家口|承德|沧州|廊坊|衡水|Shijiazhuang|Shihkiachwang|Shichiachiang|Tangshan|Qinhuangdao|Handan|Xingtai|Baoding|Paoting|Zhangjiakou|Kalgan|Changchiakow|Chengde|Cangzhou|Langfang|Hengshui/i,"山西":/山西|Shanxi|Shansi|太原|大同|阳泉|长治|晋城|朔州|晋中|运城|忻州|临汾|吕梁|Taiyuan|Datong|Tatung|Yangquan|Changzhi|Jincheng|Shuozhou|Jinzhong|Yuncheng|Xinzhou|Linfen|Luliang/i,"辽宁":/辽宁|Liaoning|沈阳|大连|鞍山|抚顺|本溪|丹东|锦州|营口|阜新|辽阳|盘锦|铁岭|朝阳|葫芦岛|Shenyang|Mukden|Fengtien|Dalian|Dairen|Talien|Anshan|Fushun|Benxi|Dandong|Antung|Jinzhou|Chinchow|Yingkou|Fuxin|Liaoyang|Panjin|Tieling|Chaoyang|Huludao/i,"吉林":/吉林|Jilin|Kirin|Chilin|长春|四平|辽源|通化|白山|松原|白城|延边|Changchun|Hsinking|Siping|Liaoyuan|Tonghua|Baishan|Songyuan|Baicheng|Yanbian/i,"黑龙江":/黑龙江|Heilongjiang|Heilungkiang|哈尔滨|齐齐哈尔|鸡西|鹤岗|双鸭山|大庆|伊春|佳木斯|七台河|牡丹江|黑河|绥化|大兴安岭|Harbin|Qiqihar|Tsitsihar|Chichihaerh|Jixi|Hegang|Shuangyashan|Daqing|Yichun|Jiamusi|Chiamussu|Qitaihe|Mudanjiang|Mutankiang|Heihe|Suihua|Daxinganling/i,"四川":/四川|Sichuan|Szechwan|Szechuan|成都|自贡|攀枝花|泸州|德阳|绵阳|广元|遂宁|内江|乐山|南充|眉山|宜宾|广安|达州|雅安|巴中|资阳|阿坝|甘孜|凉山|Chengdu|Chengtu|Zigong|Panzhihua|Luzhou|Luchow|Deyang|Mianyang|Mienchiang|Guangyuan|Suining|Neijiang|Leshan|Kiating|Nanchong|Nanchung|Meishan|Yibin|Ipin|Guangan|Dazhou|Yaan|Bazhong|Ziyang|Aba|Ganzi|Liangshan/i,"贵州":/贵州|Guizhou|Kweichow|贵阳|六盘水|遵义|安顺|毕节|铜仁|黔西南|黔东南|黔南|Guiyang|Kweiyang|Liupanshui|Zunyi|Tsunyi|Anshun|Bijie|Tongren|Qianxinan|Qiandongnan|Qiannan/i,"云南":/云南|Yunnan|昆明|曲靖|玉溪|保山|昭通|丽江|普洱|临沧|楚雄|红河|文山|西双版纳|大理|德宏|怒江|迪庆|Kunming|Yunnanfu|Qujing|Yuxi|Baoshan|Zhaotong|Lijiang|Likiang|Puer|Lincang|Chuxiong|Honghe|Wenshan|Xishuangbanna|Dali|Tali|Dehong|Nujiang|Diqing/i,"西藏":/西藏|Tibet|藏语|拉萨|日喀则|昌都|林芝|山南|那曲|阿里|Lhasa|Lasa|Shigatse|Xigazê|Chamdo|Changdu|Nyingchi|Linzhi|Shannan|Nagqu|Naqu/i,"陕西":/陕西|Shaanxi|Shensi|西安|铜川|宝鸡|咸阳|渭南|延安|汉中|榆林|安康|商洛|Xian|Xi.an|Sian|Hsian|Sianfu|Tongchuan|Baoji|Paochi|Xianyang|Hsienyang|Weinan|Yanan|Yenan|Hanzhong|Hanchung|Yulin|Ankang|Shangluo/i,"甘肃":/甘肃|Gansu|Kansu|兰州|嘉峪关|金昌|白银|天水|武威|张掖|平凉|酒泉|庆阳|定西|陇南|临夏|甘南|Lanzhou|Lanchow|Jiayuguan|Jinchang|Baiyin|Tianshui|Tienshui|Wuwei|Liangchow|Zhangye|Changyeh|Pingliang|Jiuquan|Chiuchuan|Qingyang|Dingxi|Longnan|Linxia|Gannan/i,"青海":/青海|Qinghai|Tsinghai|Chinghai|西宁|海东|海北|黄南|海南州|果洛|玉树|Xining|Sining|Haidong|Haibei|Huangnan|Hainanzhou|Guoluo|Yushu/i,"新疆":/新疆|Xinjiang|Sinkiang|维吾尔|乌鲁木齐|克拉玛依|吐鲁番|哈密|昌吉|博尔塔拉|巴音郭楞|阿克苏|克孜勒苏|喀什|和田|伊犁|塔城|阿勒泰|Urumqi|Urumchi|Wulumuqi|Karamay|Turpan|Tulufan|Hami|Changji|Bortala|Boertala|Bayingolin|Bayinguoleng|Aksu|Akesu|Kizilsu|Kashgar|Kashi|Hotan|Hetian|Khotan|Ili|Yili|Tacheng|Altay|Aletai/i,"宁夏":/宁夏|Ningxia|Ningsia|银川|石嘴山|吴忠|固原|中卫|Yinchuan|Shizuishan|Wuzhong|Guyuan|Zhongwei/i,"内蒙古":/内蒙古|内蒙|呼和浩特|包头|乌海|赤峰|通辽|鄂尔多斯|呼伦贝尔|巴彦淖尔|乌兰察布|兴安盟|锡林郭勒|阿拉善|蒙古语|Hohhot|Huhehaote|Kweisui|Kweihua|Suiyuan|Baotou|Paotow|Wuhai|Chifeng|Tongliao|Ordos|Eerduosi|Hulunbuir|Hulunbeier|Bayannur|Ulanqab|Wulanchabu|Hinggan|Xingan|Xilingol|Xilinguole|Alxa|Alasha/i};function detectProvince(n){for(const[e,t]of Object.entries(provincePatterns))if(t.test(n))return e;return"其他"}const T2S_PAIRS="電电廣广臺台灣湾國国語语樂乐聽听聞闻節节體体聯联頻频粵粤鳳凤閩闽衛卫娛娱兒儿時时藝艺經经綜综總总發发傳传興兴會会來来為为當当進进長长開开關关東东風风愛爱聲声話话見见號号陽阳業业際际與与個个們们無无網网訊讯線线頭头動动車车萬万問问題题員员點点書书學学習习導导親亲實实歡欢雲云務务優优麗丽農农濟济環环夢梦島岛億亿說说讀读寫写還还兩两橋桥飛飞遠远遊游運运龍龙馬马魚鱼鳥鸟畫画歷历參参義义專专權权產产術术設设備备試试驗验應应響响壓压質质標标達达請请項项紅红綠绿藍蓝純纯維维積积編编繼继給给結结絕绝視视報报後后廳厅銀银鐘钟論论錄录類类齊齐鬥斗頂顶",T2S_MAP={};for(let n=0;268>n;n+=2)T2S_MAP[T2S_PAIRS[n]]=T2S_PAIRS[n+1];function normalizeZh(n){return n.replace(/[\u4e00-\u9fff]/g,n=>T2S_MAP[n]||n)}function preprocessNewStations(n){n.forEach(n=>{const e=normalizeZh(n.name);if(n._nameLower=e.toLowerCase(),n._types=typeKeys.filter(n=>typePatterns[n].test(e)),"中国"===n.region){const t=detectProvince(e);"其他"!==t&&n._types.unshift(t)}0===n._types.length&&(n._types=["其他"])})}function preprocessStations(n){preprocessNewStations(allStations=n)}const BATCH_SIZE=100;let currentRegion="all",currentType="",currentSearch="",visibleCount=100,isLoading=!1,currentUrl="",currentStation=null,stationsFullyLoaded=!1,isManuallyStopped=!1,retryCount=0,retryStartTime=0,retryTimer=null,stallTimer=null;const MAX_RETRIES=30,MAX_RETRY_MS=6e5,STALL_TIMEOUT=15e3;let cachedStationTotal=0,currentLang="en",i18n={},showFavoritesOnly=!1,favorites=[];const LABEL_KEYS=<?php echo json_encode(LABEL_KEYS,   JSON_UNESCAPED_UNICODE); ?>,THEME_COLORS={green:"#22c55e",teal:"#14b8a6",cyan:"#06b6d4",orange:"#f97316",amber:"#f59e0b",rose:"#f43f5e",red:"#dc2626",pink:"#ec4899",purple:"#a855f7",indigo:"#6366f1",grayscale:"#888",bw:"#ddd",black:"#ffffff"},THEME_KEYS=["green","teal","cyan","orange","amber","rose","red","pink","purple","indigo","grayscale","bw","black"],LANG_OPTIONS=<?php
        ...
        ?>,SUPPORTED_LANGS=LANG_OPTIONS.map(n=>n.value);function esc(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function isSameStation(n,e){return n&&e&&n.url===e.url&&n.name===e.name}let filteredCache=null;$(function(){function n(n){return favorites.some(e=>e.url===n.url&&e.name===n.name)}function e(){const n=favorites.length,e=d("favOnlyToggle")||"仅显示收藏";$("#favOnlyBtn").attr("title",n>0?e+" ("+n+")":e)}function t(){if(!currentStation)return void $("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").removeClass("fav-active");const e=n(currentStation);$("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").toggleClass("fav-active",e);const t=e?d("favRemove")||"取消收藏":d("favAdd")||"收藏";$("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").attr("title",t)}function a(n){const a=favorites.findIndex(e=>e.url===n.url&&e.name===n.name),l=0>a;l?favorites.push({name:n.name,url:n.url,logo:n.logo||null,region:n.region||"",country:n.country||""}):favorites.splice(a,1),localStorage.setItem("favorites",JSON.stringify(favorites)),e(),$(".station-fav-btn").each(function(){$(this).attr("data-url")===n.url&&$(this).attr("data-name")===n.name&&$(this).toggleClass("fav-active",l).attr("title",l?d("favRemove")||"取消收藏":d("favAdd")||"收藏")}),t(),showFavoritesOnly&&(filteredCache=null,i(),o())}function i(e=!1){if(!allStations.length&&!showFavoritesOnly)return void $("#resultCount").text(d(stationsFullyLoaded?"noStations":"loading"));e&&(filteredCache=null,visibleCount=100);const t=function(){if(filteredCache)return filteredCache;if(showFavoritesOnly){const n=[],e=new Set;return favorites.forEach(t=>{if(e.has(t.name))return;if(e.add(t.name),currentSearch&&!normalizeZh(t.name).toLowerCase().includes(currentSearch))return;const a=allStations.find(n=>n.url===t.url&&n.name===t.name);n.push(a||{name:t.name,url:t.url,logo:t.logo||null,region:t.region||"",country:t.country||"",_types:[],_nameLower:normalizeZh(t.name).toLowerCase(),_invalid:stationsFullyLoaded})}),filteredCache=n,n}const n=[],e=new Set;for(let t=0;allStations.length>t;t++){const a=allStations[t];e.has(a.name)||"all"!==currentRegion&&a.region!==currentRegion||currentSearch&&!a._nameLower.includes(currentSearch)||(""===currentType||a._types.includes(currentType))&&(e.add(a.name),n.push(a))}return filteredCache=n,n}(),a=t.slice(0,visibleCount);if(function(e){let t="";e.forEach(e=>{const a=n(e),i=!!e._invalid,o=e.logo&&"null"!==e.logo?`<img src="${e.logo}" class="station-logo" alt="" loading="lazy">`:`<div class="station-logo placeholder">${SVG_LOGO_SM}</div>`,l=(isSameStation(e,currentStation)&&(()=>{const n=document.getElementById("audioPlayer");return!!n.src&&n.src!==location.href&&!n.paused})()?" playing":"")+(i?" station-invalid":"");let r="";e.country&&(r=`<span class="region-tag"><img src="https://flagcdn.com/w20/${regionCodes[e.country]||"un"}.png" alt="" class="region-tag-flag"><span class="region-tag-name">${esc(m(e.country))}</span></span>`);const s=(e._types||[]).map(n=>`<span class="type-tag">${esc(m(n))}</span>`).join(""),u=i?`<span class="invalid-badge">⚠ ${d("invalidStation")||"失效"}</span>`:"";t+=`<div class="station-card${l}" data-url="${esc(e.url)}" data-name="${esc(e.name)}">\n                        ${o}\n                        <div class="station-content">\n                            <div class="station-name">${esc(e.name)}</div>\n                            <div class="station-meta">\n                                ${r}${s}${u}\n                            </div>\n                        </div>\n                        <div class="station-actions">\n                            <span class="playing-badge"><span class="playing-badge-dot"></span>${d("playerPlaying")||"正在播放"}</span>\n                            <button class="station-fav-btn${a?" fav-active":""}" data-url="${esc(e.url)}" data-name="${esc(e.name)}" title="${a?d("favRemove")||"取消收藏":d("favAdd")||"收藏"}">\n                                ${FAV_HEART_SVG}\n                            </button>\n                            <button class="station-play-btn" data-url="${esc(e.url)}" data-name="${esc(e.name)}" title="${d("playButton")||"播放"}">\n                                <svg viewBox="0 0 24 24"><polygon points="6,4 20,12 6,20"/></svg>\n                            </button>\n                            <button class="station-stop-btn" data-url="${esc(e.url)}" data-name="${esc(e.name)}" title="${d("pauseButton")||"暂停"}">\n                                <svg viewBox="0 0 24 24"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>\n                            </button>\n                        </div>\n                    </div>`}),$("#stationsGrid").html(t)}(a),showFavoritesOnly&&0===t.length){const n=0===favorites.length?d("noFavStations")||"没有收藏的电台":d("noStations")||"无匹配结果";return $("#stationsGrid").html(`<div class="no-results">${n}</div>`),$("#resultCount").text("0 / 0"),void $("#loadingMore").removeClass("show")}const i=stationsFullyLoaded?"":d("loadingSuffix");$("#resultCount").text(d("showingCount",{shown:a.length,total:t.length,suffix:i})),$("#loadingMore").toggleClass("show",t.length>visibleCount)}function o(){const n=function(){const n=[],e=new Set;if(showFavoritesOnly)return favorites.forEach(t=>{if(e.has(t.name))return;if(currentSearch&&!normalizeZh(t.name).toLowerCase().includes(currentSearch))return;e.add(t.name);const a=allStations.find(n=>n.url===t.url&&n.name===t.name);a&&n.push(a)}),n;for(let t=0;allStations.length>t;t++){const a=allStations[t];e.has(a.name)||"all"!==currentRegion&&a.region!==currentRegion||currentSearch&&!a._nameLower.includes(currentSearch)||(e.add(a.name),n.push(a))}return n}(),e={};n.forEach(n=>n._types.forEach(n=>{e[n]=(e[n]||0)+1}));const t=new Set(Object.keys(provincePatterns)),a=new Set(Object.keys(typePatterns)),i=["全国","央广","央视"];let o;if("中国"===currentRegion){const n=i.filter(n=>e[n]),l=Object.keys(e).filter(n=>t.has(n)&&!i.includes(n)&&"其他"!==n).sort((n,t)=>e[t]-e[n]),r=Object.keys(e).filter(n=>a.has(n)&&!i.includes(n)&&"其他"!==n).sort((n,t)=>e[t]-e[n]);o=[...n,...l,...r,...e["其他"]?["其他"]:[]]}else o=Object.keys(e).filter(n=>"其他"!==n&&!t.has(n)).sort((n,t)=>e[t]-e[n]),e["其他"]&&o.push("其他");let l=`<button class="type-btn ${""===currentType?"active":""}" data-type="">${d("all")}</button>`;o.forEach(n=>{l+=`<button class="type-btn ${currentType===n?"active":""}" data-type="${n}">${m(n)}(${e[n]})</button>`}),$("#typeBtns").html(l)}function l(){const n=new Set;let e=0;const t={},a={};allStations.forEach(i=>{n.has(i.name)||(n.add(i.name),e++),a[i.region]||(a[i.region]=new Set),a[i.region].has(i.name)||(a[i.region].add(i.name),t[i.region]=(t[i.region]||0)+1)}),$('.region-btn[data-region="all"]').data("count",e),Object.entries(t).forEach(([n,e])=>{$(`.region-btn[data-region="${n}"]`).data("count",e)}),cachedStationTotal=e,p(),$("#totalSubtitle").text(d("totalStations",{total:e}))}function r(n,e=!0){currentUrl=n.url,currentStation=n,retryCount=0,retryStartTime=0,clearTimeout(retryTimer),clearTimeout(stallTimer),localStorage.setItem("play_url",n.url),localStorage.setItem("play_name",n.name),t();const a=document.getElementById("audioPlayer");a.volume=parseFloat(localStorage.getItem("player_volume"))||.5,$("#playerTitle, #fullscreenTitle").text(n.name),function(){if(!currentStation)return;const n=currentStation.logo&&"null"!==currentStation.logo?currentStation.logo:null,e=$("#miniPlayerLogo");n?e.removeClass("placeholder").html('<img src="'+n+'" alt="">'):e.addClass("placeholder").html(SVG_LOGO_SM),$("#miniPlayerName").text(currentStation.name),A()}();const i=n.logo&&"null"!==n.logo?n.logo:null;$("#playerLogo").replaceWith(i?`<img src="${i}" class="player-logo" id="playerLogo" alt="">`:`<div class="player-logo placeholder" id="playerLogo">${SVG_LOGO_MD}</div>`),i?$("#fullscreenCover").replaceWith(`<img src="${i}" class="fullscreen-cover" id="fullscreenCover" alt="">`):$("#fullscreenCover").replaceWith(`<div class="fullscreen-cover placeholder" id="fullscreenCover">${SVG_LOGO_LG}</div>`),$(".station-card").removeClass("playing"),e&&$(".station-card").filter(function(){return $(this).attr("data-url")===n.url&&$(this).attr("data-name")===n.name}).addClass("playing"),e?($("#playerStatus, #fullscreenStatus").text(d("playerLoading")),$("#statusDot, #fullscreenDot").removeClass("playing paused"),a.src=n.url,a.play().catch(n=>{console.warn("自动播放被阻止，请点击播放条开始播放:",n),$("#playerStatus, #fullscreenStatus").text(d("playerClickToPlay")),$("#statusDot, #fullscreenDot").addClass("paused"),u(!0),P(!0)})):($("#playerStatus, #fullscreenStatus").text(d("playerClickToPlay")),$("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),u(!0),P(!0)),h()}function s(){if(isManuallyStopped||!currentStation)return;clearTimeout(retryTimer),clearTimeout(stallTimer);const n=Date.now();if(0===retryCount&&(retryStartTime=n),retryCount>=30)return $("#playerStatus, #fullscreenStatus").text(d("playerError")),$("#miniPlayerStatus").text(d("playerError")),void console.warn("已达最大重试次数，停止重连");if(retryStartTime>0&&n-retryStartTime>=6e5)return $("#playerStatus, #fullscreenStatus").text(d("playerError")),$("#miniPlayerStatus").text(d("playerError")),void console.warn("超过最长重试时间 10 分钟，停止重连");retryCount++;const e=Math.min(3e4,3e3*Math.pow(2,Math.min(retryCount-1,3))),t=n-retryStartTime,a=Math.min(e,6e5-t),i=Math.round(a/1e3),o=`${d("playerRetrying")||"重连中"} (${retryCount}/30) … ${i}s`;$("#playerStatus, #fullscreenStatus").text(o),$("#miniPlayerStatus").text(o),console.warn(`音频重连 #${retryCount}，${i}s 后重试（已用 ${Math.round(t/1e3)}s）`),retryTimer=setTimeout(()=>{if(isManuallyStopped||!currentStation)return;if(Date.now()-retryStartTime>=6e5)return $("#playerStatus, #fullscreenStatus").text(d("playerError")),$("#miniPlayerStatus").text(d("playerError")),void console.warn("超过最长重试时间 10 分钟，停止重连");const n=document.getElementById("audioPlayer");n.src=currentStation.url,n.load(),n.play().catch(n=>console.warn("重试播放失败:",n))},a)}function u(n){const e=n?'<polygon points="6,4 20,12 6,20"/>':'<rect x="5" y="4" width="4" height="16"/><rect x="15" y="4" width="4" height="16"/>';$("#playIcon").html(e)}function c(){if(!currentStation)return;const n=document.getElementById("audioPlayer");n.volume=parseFloat(localStorage.getItem("player_volume"))||.5,n.src&&n.src!==window.location.href||(n.src=currentStation.url),n.paused?n.play().catch(n=>console.warn("播放失败:",n)):(isManuallyStopped=!0,retryCount=0,retryStartTime=0,clearTimeout(retryTimer),clearTimeout(stallTimer),n.pause(),n.src="",$("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),$("#playerStatus, #fullscreenStatus").text(d("playerClickToPlay")),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),u(!0),P(!0),$(".station-card").removeClass("playing"),G(!0),$("#miniPlayerStatus").text(d("playerPaused")||"已暂停"),document.title=d("appTitle"))}function g(){$("#regionFilterLabel").text("· "+("all"!==currentRegion?m(currentRegion):d("all"))),$("#typeFilterLabel").text("· "+(""!==currentType?m(currentType):d("all")))}function h(){const n=new URLSearchParams;"all"!==currentRegion&&n.set("region",currentRegion),""!==currentType&&n.set("type",currentType),showFavoritesOnly&&n.set("fav","1"),currentStation&&(n.set("play",currentStation.url),n.set("play_name",currentStation.name)),history.replaceState(null,"",n.toString()?"?"+n:location.pathname)}function d(n,e={}){return String(i18n[n]||n).replace(/\{\{(\w+)\}\}/g,(n,t)=>e[t]??"")}function m(n){const e=LABEL_KEYS[n]||n;return i18n.labels&&i18n.labels[e]?i18n.labels[e]:n}function p(){$(".region-btn").each(function(){const n=$(this).data("region"),e=$(this).data("count"),t=$(this).data("flag-code")||"un",a="all"===n?d("all"):m(n),i=void 0!==e?"("+e+")":"";$(this).html(`<img src="https://flagcdn.com/w20/${t}.png" alt="" class="region-flag"> ${a}${i}`)})}function y(n){return fetch(`lang/${n}.json`,{cache:"no-cache"}).then(n=>{if(!n.ok)throw new Error("Locale not found");return n.json()}).then(e=>{i18n=e,currentLang=n,function(){if($("[data-i18n]").each(function(){const n=$(this).data("i18n"),e=$(this),t=e.children().detach();e.text(d(n)),e.append(t)}),$("[data-i18n-placeholder]").each(function(){const n=$(this).data("i18n-placeholder");$(this).attr("placeholder",d(n))}),$("[data-i18n-title]").each(function(){const n=$(this).data("i18n-title");$(this).attr("title",d(n))}),stationsFullyLoaded?$("#totalSubtitle").text(d("totalStations",{total:cachedStationTotal})):$("#totalSubtitle").text(d("subtitleLoading")),function(){const n=THEME_KEYS.map(n=>{const e="bw"===n?"themeBW":"grayscale"===n?"themeGrayscale":"theme"+n.charAt(0).toUpperCase()+n.slice(1);return`<div class="theme-item${n===($("html").attr("data-theme")||"green")?" active":""}" data-theme="${n}"><span class="theme-item-dot" style="background:${THEME_COLORS[n]}"></span><span>${d(e)}</span></div>`}).join("");$("#themePanel").html(n)}(),f($("html").attr("data-theme")||"green"),S(currentLang),$("#themePickerBtn").attr("aria-label",d("theme")),$("#langPickerBtn").attr("aria-label",d("language")),g(),i(),p(),stationsFullyLoaded&&o(),currentStation){$("#playerTitle, #fullscreenTitle").text(currentStation.name),$("#miniPlayerName").text(currentStation.name),document.title=currentStation.name+" — "+d("appTitle");const n=document.getElementById("audioPlayer");let e,t;n.error?(e="playerError",t="playerError"):n.paused?(e="playerClickToPlay",t="playerPaused"):(e="playerPlaying",t="playerPlaying"),$("#playerStatus, #fullscreenStatus").text(d(e)),$("#miniPlayerStatus").text(d(t))}else document.title=d("appTitle"),$("#fullscreenStatus").text(d("playerWaiting"));t()}()}).catch(()=>{if("en"!==n)return y("en")})}function f(n){$("#themePickerDot").css("background",THEME_COLORS[n]||THEME_COLORS.green);const e="bw"===n?"themeBW":"grayscale"===n?"themeGrayscale":"theme"+n.charAt(0).toUpperCase()+n.slice(1);$("#themePickerLabel").text(d(e)),$("#themePanel .theme-item").removeClass("active").filter(`[data-theme="${n}"]`).addClass("active")}function S(n){const e=LANG_OPTIONS.find(e=>e.value===n)||LANG_OPTIONS[0];$("#langPickerFlag").attr("src",`https://flagcdn.com/w20/${e.flag}.png`),$("#langPickerLabel").text(e.label),$("#langPanel .lang-item").removeClass("active").filter(`[data-lang="${n}"]`).addClass("active")}function v(n){$("html").attr("data-theme",n),localStorage.setItem("theme",n),f(n)}let C;$("#stationsGrid").on("click",".station-card",function(){const n=$(this).attr("data-url"),e=$(this).attr("data-name"),t=allStations.find(e?t=>t.url===n&&t.name===e:e=>e.url===n);t&&r(t)}),$("#regionBtns").on("click",".region-btn",function(){var n;n=$(this).attr("data-region"),currentRegion=n,currentType="",localStorage.setItem("region",n),localStorage.removeItem("type"),$(".region-btn").removeClass("active"),$(`.region-btn[data-region="${n}"]`).addClass("active"),o(),i(!0),h(),g()}),$("#typeBtns").on("click",".type-btn",function(){var n;n=$(this).attr("data-type"),currentType=n,localStorage.setItem("type",n),o(),i(!0),h(),g()}),$("#favOnlyBtn").on("click",function(){var n;showFavoritesOnly=n=!showFavoritesOnly,localStorage.setItem("favOnly",n?"1":"0"),$("#favOnlyBtn").toggleClass("active",n),$("body").toggleClass("fav-only-mode",n),filteredCache=null,i(!0),o(),h()}),$("#stationsGrid").on("click",".station-fav-btn",function(n){n.stopPropagation();const e=$(this).attr("data-url"),t=$(this).attr("data-name");let i=allStations.find(t?n=>n.url===e&&n.name===t:n=>n.url===e);if(!i){const n=favorites.find(n=>n.url===e&&n.name===t);n&&(i={name:n.name,url:n.url,logo:n.logo||null,region:n.region||"",country:n.country||""})}i&&a(i)}),$("#miniFavBtn, #fullscreenFavBtn, #playerFavBtn").on("click",function(){currentStation&&a(currentStation)}),function(){const n=LANG_OPTIONS.map(n=>`<div class="lang-item${n.value===currentLang?" active":""}" data-lang="${n.value}"><img src="https://flagcdn.com/w20/${n.flag}.png" alt=""><span>${n.label}</span></div>`).join("");$("#langPanel").html(n)}(),S(currentLang),$("#themePickerBtn").on("click",function(n){n.stopPropagation();const e=$("#themePickerWrap"),t=e.hasClass("open");$(".picker-wrap").removeClass("open"),t||e.addClass("open")}),$("#langPickerBtn").on("click",function(n){n.stopPropagation();const e=$("#langPickerWrap"),t=e.hasClass("open");$(".picker-wrap").removeClass("open"),t||e.addClass("open")}),$(document).on("click",".theme-item",function(n){n.stopPropagation(),v($(this).data("theme")),$(".picker-wrap").removeClass("open")}),$(document).on("click",".lang-item",function(n){var e;n.stopPropagation(),e=$(this).data("lang"),SUPPORTED_LANGS.includes(e)&&(localStorage.setItem("language",e),y(e)),$(".picker-wrap").removeClass("open")}),$(document).on("click",".picker-panel",function(n){n.stopPropagation()}),$(document).on("click",function(){$(".picker-wrap").removeClass("open")}),$("#regionsToggle").on("click",function(){$("#regionsContent").toggleClass("collapsed"),$(this).find(".toggle-icon").toggleClass("collapsed")}),$("#typesToggle").on("click",function(){$("#typesContent").toggleClass("collapsed"),$(this).find(".toggle-icon").toggleClass("collapsed")}),$("#searchInput").on("input",function(){clearTimeout(C),C=setTimeout(()=>{currentSearch=normalizeZh($(this).val().toLowerCase()),i(!0),o()},300)}),function(){const n=document.getElementById("loadingMore");n&&new IntersectionObserver(function(n){n[0].isIntersecting&&(isLoading||(isLoading=!0,visibleCount+=100,i(),isLoading=!1))},{rootMargin:"200px"}).observe(n)}(),$("#audioPlayer").on("play",function(){retryCount=0,retryStartTime=0,clearTimeout(retryTimer),clearTimeout(stallTimer),$("#statusDot, #fullscreenDot").removeClass("paused").addClass("playing"),$("#playerStatus, #fullscreenStatus").text(d("playerPlaying")),G(!1),$("#miniPlayerStatus").text(d("playerPlaying")),$("#soundWave").addClass("playing"),$("#fullscreenCover").addClass("playing"),u(!1),P(!1),currentStation&&($(".station-card").removeClass("playing").filter(function(){return $(this).attr("data-url")===currentStation.url&&$(this).attr("data-name")===currentStation.name}).addClass("playing"),document.title=currentStation.name+" — "+d("appTitle"))}).on("pause",function(){$("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),$("#playerStatus, #fullscreenStatus").text(d("playerClickToPlay")),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),u(!0),P(!0),$(".station-card").removeClass("playing"),G(!0),$("#miniPlayerStatus").text(d("playerPaused")||"已暂停"),document.title=d("appTitle")}).on("volumechange",function(){localStorage.setItem("player_volume",this.volume),b(this.volume)}).on("stalled waiting",function(){isManuallyStopped||(clearTimeout(stallTimer),stallTimer=setTimeout(()=>{const n=document.getElementById("audioPlayer");!n.paused&&3>n.readyState&&s()},15e3))}).on("playing",function(){clearTimeout(stallTimer)}).on("error",function(){isManuallyStopped?isManuallyStopped=!1:($("#statusDot, #fullscreenDot").removeClass("playing").addClass("paused"),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),u(!0),P(!0),$(".station-card").removeClass("playing"),A(),console.error("音频加载错误，准备重试"),s())}),$("#playerBar").on("click",function(n){$(n.target).closest("audio, .fullscreen-btn, .volume-control").length||c()});const w={mute:'<polygon points="11,5 6,9 2,9 2,15 6,15 11,19"/><line x1="23" y1="9" x2="17" y2="15" stroke-linecap="round"/><line x1="17" y1="9" x2="23" y2="15" stroke-linecap="round"/>',low:'<polygon points="11,5 6,9 2,9 2,15 6,15 11,19"/><path d="M15.54,8.46a5,5,0,0,1,0,7.07"/>',med:'<polygon points="11,5 6,9 2,9 2,15 6,15 11,19"/><path d="M15.54,8.46a5,5,0,0,1,0,7.07"/><path d="M19.07,4.93a10,10,0,0,1,0,14.14"/>',high:'<polygon points="11,5 6,9 2,9 2,15 6,15 11,19"/><path d="M15.54,8.46a5,5,0,0,1,0,7.07"/><path d="M19.07,4.93a10,10,0,0,1,0,14.14"/>'};function b(n){const e=Math.round(100*n),t=e+"%",a=function(n){return 0===n?w.mute:.35>n?w.low:.7>n?w.med:w.high}(n);$("#barVolumeIcon, #miniVolumeIcon, #fsVolumeIcon").html(a),$(".volume-slider-input").val(e).each(function(){this.style.setProperty("--vol",e+"%")}),$(".volume-label").text(t)}function T(n,e,t,a){t.stopPropagation();const i=$("#"+e),o=i.hasClass("show");if($(".volume-popup").removeClass("show"),o)return;i.parent().is("body")||$("body").append(i);const l=document.getElementById(n).getBoundingClientRect();let r=l.left+l.width/2-22,s=l.top-132-8-(a||0);r=Math.max(8,Math.min(r,window.innerWidth-44-8)),8>s&&(s=l.bottom+8),i.css({top:s+"px",left:r+"px"}),i.addClass("show")}$("#barVolumeBtn").on("click",function(n){T("barVolumeBtn","barVolumePopup",n)}),$("#miniVolumeBtn").on("click",function(n){T("miniVolumeBtn","miniVolumePopup",n,4)}),$("#fsVolumeBtn").on("click",function(n){T("fsVolumeBtn","fsVolumePopup",n)});let k=null;function P(n){const e=n?'<polygon points="8,5 19,12 8,19"/>':'<rect x="7" y="5" width="3" height="14"/><rect x="14" y="5" width="3" height="14"/>';$("#fullscreenPlayBtn svg").html(e)}$(document).on("mouseenter.volHide","#barVolumeBtn, #barVolumePopup, #miniVolumeBtn, #miniVolumePopup, #fsVolumeBtn, #fsVolumePopup",function(){clearTimeout(k)}),$(document).on("mouseleave.volHide","#barVolumeBtn, #barVolumePopup, #miniVolumeBtn, #miniVolumePopup, #fsVolumeBtn, #fsVolumePopup",function(){clearTimeout(k),k=setTimeout(function(){$(".volume-popup").removeClass("show")},1500)}),$("#barVolumeSlider, #miniVolumeSlider, #fsVolumeSlider").on("input",function(){var n;n=parseInt(this.value,10),document.getElementById("audioPlayer").volume=Math.max(0,Math.min(1,n/100))}),$(".volume-popup").on("click",function(n){n.stopPropagation()}),$(document).on("click.volumeClose",function(){clearTimeout(k),$(".volume-popup").removeClass("show")}),b(document.getElementById("audioPlayer").volume);let x=!1,L=null,z=!1,B=!1,_=!1,H=null;async function E(){if("wakeLock"in navigator)try{H=await navigator.wakeLock.request("screen"),H.addEventListener("release",()=>{H=null})}catch(n){}}function O(){H&&(H.release(),H=null)}function F(){$("#fullscreenPlayer").addClass("show"),function(){if(!currentStation)return;$("#fullscreenTitle").text(currentStation.name);const n=currentStation.logo&&"null"!==currentStation.logo?currentStation.logo:null;n?$("#fullscreenCover").replaceWith(`<img src="${n}" class="fullscreen-cover" id="fullscreenCover" alt="">`):$("#fullscreenCover").replaceWith(`<div class="fullscreen-cover placeholder" id="fullscreenCover">${SVG_LOGO_LG}</div>`),document.getElementById("audioPlayer").paused||($("#fullscreenCover").addClass("playing"),$("#soundWave").addClass("playing"))}();const n=window.scrollY;$("body").css({overflow:"hidden",position:"fixed",top:-n+"px",width:"100%"}),$("body").data("scroll-y",n),E(),W(),L||(L=setInterval(W,1e3))}function I(){$("#fullscreenPlayer").removeClass("show");const n=$("body").data("scroll-y")||0;$("body").css({overflow:"",position:"",top:"",width:""}),window.scrollTo(0,n),x=!1,_=!1,O(),L&&(clearInterval(L),L=null),(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement)&&(document.exitFullscreen||document.webkitExitFullscreen||document.mozCancelFullScreen||function(){}).call(document)}function M(){const n=document.documentElement,e=n.requestFullscreen||n.webkitRequestFullscreen||n.mozRequestFullScreen||n.msRequestFullscreen;e&&e.call(n).catch(()=>{})}function R(){const n=window.matchMedia("(max-width: 900px) and (orientation: landscape) and (max-height: 500px) and (hover: none) and (pointer: coarse)").matches;if(n&&!z)B=!1,$("#fullscreenPlayer").hasClass("show")||(x=!0,F()),_=!0,setTimeout(function(){!$("#fullscreenPlayer").hasClass("show")||document.fullscreenElement||document.webkitFullscreenElement||M()},300);else if(!n&&(B=!1,_=!1,$("#fullscreenPlayer").hasClass("show")&&x)){x=!1,$("#fullscreenPlayer").removeClass("show");const n=$("body").data("scroll-y")||0;$("body").css({overflow:"",position:"",top:"",width:""}),window.scrollTo(0,n),O(),(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement)&&(document.exitFullscreen||document.webkitExitFullscreen||document.mozCancelFullScreen||function(){}).call(document)}z=n}function W(){const n=new Date,e=String(n.getHours()).padStart(2,"0"),t=String(n.getMinutes()).padStart(2,"0"),a=String(n.getSeconds()).padStart(2,"0");$("#fullscreenClock").text(e+":"+t+":"+a)}function A(){currentStation?$("#miniPlayer").addClass("has-station"):$("#miniPlayer").removeClass("has-station")}function G(n){const e=n?'<polygon points="6,4 20,12 6,20"/>':'<rect x="5" y="4" width="4" height="16"/><rect x="15" y="4" width="4" height="16"/>';$("#miniPlayIcon").html(e)}document.addEventListener("visibilitychange",function(){"visible"===document.visibilityState&&$("#fullscreenPlayer").hasClass("show")&&E()}),$("#fullscreenPlayer").on("touchstart.fspend pointerdown.fspend",function(){_&&$("#fullscreenPlayer").hasClass("show")&&!document.fullscreenElement&&!document.webkitFullscreenElement&&(_=!1,M())}),$("#fullscreenBtn").on("click",function(n){n.stopPropagation(),x=!1,B=!1,F(),setTimeout(()=>M(),100)}),$("#fullscreenClose").on("click",function(){B=!0,I()}),$("#fullscreenPlayBtn").on("click",c),$(document).on("keydown",function(n){"Escape"===n.key&&$("#fullscreenPlayer").hasClass("show")&&(B=!0,I())}),$(window).on("orientationchange resize",R),$(document).on("fullscreenchange webkitfullscreenchange mozfullscreenchange",function(){if(!document.fullscreenElement&&!document.webkitFullscreenElement&&!document.mozFullScreenElement&&$("#fullscreenPlayer").hasClass("show")){B=!0,x=!1,$("#fullscreenPlayer").removeClass("show");const n=$("body").data("scroll-y")||0;$("body").css({overflow:"",position:"",top:"",width:""}),window.scrollTo(0,n),O()}}),R(),$(window).on("scroll.backtotop",function(){$(this).scrollTop()>300?($("#miniPlayer").addClass("show"),$("body").addClass("mini-player-visible")):($("#miniPlayer").removeClass("show"),$("body").removeClass("mini-player-visible"))}),$("#backToTop").on("click",function(){$("html, body").animate({scrollTop:0},300)}),$("#miniPlayBtn").on("click",function(){c()}),$("#miniFullscreenBtn").on("click",function(n){n.stopPropagation(),x=!1,B=!1,F(),setTimeout(()=>M(),100)}),$(document).on("click",".station-play-btn",function(n){n.stopPropagation();const e=$(this).attr("data-url"),t=$(this).attr("data-name"),a=allStations.find(t?n=>n.url===e&&n.name===t:n=>n.url===e);a&&r(a)}),$(document).on("click",".station-stop-btn",function(n){n.stopPropagation();const e=document.getElementById("audioPlayer");isManuallyStopped=!0,retryCount=0,retryStartTime=0,clearTimeout(retryTimer),clearTimeout(stallTimer),e.pause(),e.src="",currentUrl="",A(),t(),i(),currentStation&&($("#playerStatus").text(d("playerClickToPlay")||"点击播放"),$("#miniPlayerStatus").text(d("playerPaused")||"已暂停"),$("#fullscreenStatus").text(d("playerClickToPlay")||"点击播放")),$("#statusDot").removeClass("playing").addClass("paused"),$("#fullscreenDot").removeClass("playing").addClass("paused"),$("#soundWave").removeClass("playing"),$("#fullscreenCover").removeClass("playing"),u(!0),P(!0),G(!0)}),function(){const n=localStorage.getItem("language"),e=navigator.languages&&navigator.languages[0]||navigator.language||"en",t=e.startsWith("zh-TW")||e.startsWith("zh-HK")||e.startsWith("zh-MO")?"zh-HK":e.startsWith("zh")?"zh-CN":e.startsWith("es")?"es":e.startsWith("fr")?"fr":e.startsWith("de")?"de":e.startsWith("it")?"it":e.startsWith("ja")?"ja":e.startsWith("ko")?"ko":e.startsWith("ru")?"ru":"en",a=("zh-TW"===n?"zh-HK":n)||t,i=SUPPORTED_LANGS.includes(a)?a:"en";return n&&n===i||localStorage.setItem("language",i),y(i)}().then(()=>{v(localStorage.getItem("theme")||"green"),function(){const n=new URLSearchParams(location.search),t=n.get("region"),a=n.get("type"),s=localStorage.getItem("region")||"all",u=localStorage.getItem("type")||"";!function(){try{const n=localStorage.getItem("favorites");n&&(favorites=JSON.parse(n)),Array.isArray(favorites)||(favorites=[])}catch(n){favorites=[]}}(),e();const c=n.get("fav"),m=localStorage.getItem("favOnly");("1"===c||!c&&"1"===m)&&(showFavoritesOnly=!0,$("#favOnlyBtn").addClass("active"),$("body").addClass("fav-only-mode"),"1"===c&&localStorage.setItem("favOnly","1")),currentRegion=t||s,"all"!==currentRegion&&($(".region-btn").removeClass("active"),$(`.region-btn[data-region="${currentRegion}"]`).addClass("active")),currentType=a||(s===currentRegion?u:""),t&&(localStorage.setItem("region",currentRegion),a||localStorage.removeItem("type")),a&&localStorage.setItem("type",currentType),t||currentRegion===s||localStorage.setItem("region",currentRegion),a||currentType===u||""===currentType||localStorage.setItem("type",currentType),600>window.innerWidth&&($("#typesContent").addClass("collapsed"),$("#typesToggle").find(".toggle-icon").addClass("collapsed")),g(),$("#resultCount").text(d("loading")),(async()=>{try{const t=await fetch("?action=stations");if(!t.ok)throw new Error("HTTP "+t.status);const a=t.body.getReader(),s=new TextDecoder,u=1e3,c=<?php echo $totalCount; ?>;let g="",m=[],p=!1;const y=$("#topProgressFill"),f=n=>{const e=c>0?Math.min(98,Math.round(n/c*100)):0;y.css("width",e+"%"),$("#totalSubtitle").text(d("loadingStations",{loaded:n.toLocaleString()}))},S=()=>{p||(p=!0,requestAnimationFrame(()=>{p=!1,filteredCache=null,i()}))},v=()=>{m.length&&(preprocessNewStations(m),m.forEach(n=>allStations.push(n)),m=[],f(allStations.length),S())};for(;;){const{done:t,value:c}=await a.read();if(c){g+=s.decode(c,{stream:!0});const n=g.split("\n");g=n.pop();for(const e of n)if(e.trim())try{m.push(JSON.parse(e))}catch(n){}u>m.length||v()}if(t){if(g.trim())try{m.push(JSON.parse(g.trim()))}catch(n){}v(),stationsFullyLoaded=!0,filteredCache=null,i(!0),o(),l(),e(),y.addClass("done");const t=n.get("play")||localStorage.getItem("play_url");if(t){const e=n.get("play_name")||localStorage.getItem("play_name");let a=e?allStations.find(n=>n.url===t&&n.name===e):null;a||(a=allStations.find(n=>n.url===t)),a&&(r(a,!1),n.get("play")||h())}break}}}catch(n){$("#resultCount").text(d("loadFailedRefresh"))}})()}()})});</script>
</body>
</html>